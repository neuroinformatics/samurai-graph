...
**完了基準:**
- [ ] テスト依存が追加
- [ ] `src/test/java/` ディレクトリ構造が作成
- [ ] `mvn test` が成功
- [ ] ローカルCIスクリプトでテストが自動実行される
...
| TASK-006 | テストフレームワーク導入 | [ ] | P0 | フェーズ2 | C1 |
| TASK-007 | データパーステスト作成 | [ ] | P1 | フェーズ2 | C1 |
| TASK-008 | データバッファテスト作成 | [ ] | P1 | フェーズ2 | C1 |
