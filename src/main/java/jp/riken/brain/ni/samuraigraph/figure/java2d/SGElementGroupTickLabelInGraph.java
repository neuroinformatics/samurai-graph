...
public abstract class SGElementGroupTickLabelInGraph extends SGElementGroupTickLabelForData
  ...
  protected SGElementGroupTickLabelInGraph(SGISXYTypeData data, SGFigureElementGraph graph) {
    super(data);
    this.mGraph = graph;
  }
  ...
  /** */
  protected static class TickLabelStringElement extends SGDrawingElementString2DExtended {
    ...
    protected TickLabelStringElement(SGElementGroupTickLabel tickLabelGroup, final int index) {
      super();
