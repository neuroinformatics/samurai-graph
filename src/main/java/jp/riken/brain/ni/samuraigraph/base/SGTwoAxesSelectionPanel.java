...
public class SGTwoAxesSelectionPanel extends SGAxisSelectionPanel {
  ...
  private transient SGExclusiveAccessController mHorizontalController =
      new SGExclusiveAccessController();

  private transient SGExclusiveAccessController mVerticalController =
      new SGExclusiveAccessController();
