...
import jp.riken.brain.ni.samuraigraph.figure.SGFigureElementAxis.AxisScaleElement;
...
public abstract class SGAxisElement
  ...
  private final SGAxisElementPropertyIO mPropertyIO = new SGAxisElementPropertyIO(this);
  ...
  protected boolean readScaleProperties(
    ...
    return this.mPropertyIO.readScaleProperties(element, versionNumber, dateMode);
  }
