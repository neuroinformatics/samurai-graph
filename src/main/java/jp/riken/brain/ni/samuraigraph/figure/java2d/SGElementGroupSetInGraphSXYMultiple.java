...
public class SGElementGroupSetInGraphSXYMultiple extends SGElementGroupSetInGraph
  ...
  protected SGPropertyResults setProperties(SGPropertyMap map, SGPropertyResults iResult) {
    ...
    final boolean pickUpContained =
        keys.contains(SGIDataCommandConstants.COM_DATA_PICKUP_DIMENSION.toUpperCase());
    final boolean timeContained =
      ...
      if (SGIDataCommandConstants.COM_DATA_LINE_WIDTH.equalsIgnoreCase(key)) {
        ...
        if (cl != null) {
          ...
          if (cl != null) {
            if (this.setLineColor(cl) == false) {
              result.putResult(
                  SGIDataCommandConstants.COM_DATA_LINE_COLOR,
        ...
        if (num == null) {
          result.putResult(
              SGIDataCommandConstants.COM_DATA_SHIFT_X, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        if (num == null) {
          result.putResult(
              SGIDataCommandConstants.COM_DATA_SHIFT_Y, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        if (timeContained) {
          ...
          if (!this.setPickUpDimension(value)) {
            result.putResult(
                SGIDataCommandConstants.COM_DATA_PICKUP_DIMENSION,
                SGPropertyResults.INVALID_INPUT_VALUE);
            continue;
          }
          result.putResult(
              SGIDataCommandConstants.COM_DATA_PICKUP_DIMENSION, SGPropertyResults.SUCCEEDED);
        }
        ...
        if (SGDataUtility.isNetCDFData(this.mData)) {
          ...
          // cannot apply
          result.putResult(
              SGIDataCommandConstants.COM_DATA_PICKUP_START, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        if (SGDataUtility.isNetCDFData(this.mData)) {
          ...
          // cannot apply
          result.putResult(
              SGIDataCommandConstants.COM_DATA_PICKUP_END, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        if (SGDataUtility.isNetCDFData(this.mData)) {
          ...
          // cannot apply
          result.putResult(
              SGIDataCommandConstants.COM_DATA_PICKUP_STEP, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        result.putResult(
            SGIDataCommandConstants.COM_DATA_TICK_LABEL_ARRAY_SECTION, SGPropertyResults.SUCCEEDED);
    ...
    while (itr.hasNext()) {
      ...
      if (SGIDataCommandConstants.COM_DATA_LINE_SHIFT_X.equalsIgnoreCase(key)) {
        ...
        if (num == null) {
          result.putResult(
              SGIDataCommandConstants.COM_DATA_LINE_SHIFT_X, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        for (SGElementGroupBar bar : barList) {
          ...
          if (bar.setOffsetX(barOffset) == false) {
            result.putResult(
                SGIDataCommandConstants.COM_DATA_LINE_SHIFT_X,
                SGPropertyResults.INVALID_INPUT_VALUE);
            continue;
          }
        }
        result.putResult(
            SGIDataCommandConstants.COM_DATA_LINE_SHIFT_X, SGPropertyResults.SUCCEEDED);
      } else if (SGIDataCommandConstants.COM_DATA_LINE_SHIFT_Y.equalsIgnoreCase(key)) {
        Number num = SGUtilityText.getDouble(value);
        if (num == null) {
          result.putResult(
              SGIDataCommandConstants.COM_DATA_LINE_SHIFT_Y, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        for (SGElementGroupBar bar : barList) {
          ...
          if (bar.setOffsetY(barOffset) == false) {
            result.putResult(
                SGIDataCommandConstants.COM_DATA_LINE_SHIFT_Y,
                SGPropertyResults.INVALID_INPUT_VALUE);
            continue;
          }
        }
        result.putResult(
            SGIDataCommandConstants.COM_DATA_LINE_SHIFT_Y, SGPropertyResults.SUCCEEDED);
      } else if (SGIDataCommandConstants.COM_DATA_BAR_SHIFT_X.equalsIgnoreCase(key)) {
        // only for backward compatibility
        Number num = SGUtilityText.getDouble(value);
        if (num == null) {
          result.putResult(
              SGIDataCommandConstants.COM_DATA_BAR_SHIFT_X, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        for (SGElementGroupBar bar : barList) {
          ...
          if (bar.setOffsetX(offset) == false) {
            result.putResult(
                SGIDataCommandConstants.COM_DATA_BAR_SHIFT_X,
                SGPropertyResults.INVALID_INPUT_VALUE);
            continue;
          }
        }
        ...
        if (num == null) {
          result.putResult(
              SGIDataCommandConstants.COM_DATA_BAR_SHIFT_Y, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        for (SGElementGroupBar bar : barList) {
          ...
          if (bar.setOffsetY(offset) == false) {
            result.putResult(
                SGIDataCommandConstants.COM_DATA_BAR_SHIFT_Y,
                SGPropertyResults.INVALID_INPUT_VALUE);
            continue;
          }
        }
  ...
  private boolean setPickUpIndices(
    ...
    if (SGIDataCommandConstants.COM_DATA_PICKUP_INDICES.equalsIgnoreCase(key)) {
      if (map.isDoubleQuoted(SGIDataCommandConstants.COM_DATA_PICKUP_INDICES) == false) {
        result.putResult(
            SGIDataCommandConstants.COM_DATA_PICKUP_INDICES, SGPropertyResults.INVALID_INPUT_VALUE);
        return false;
      }
      if (SGDataUtility.isNetCDFData(this.mData)) {
        ...
        if (sxyData.setPickUpDimensionInfo(info) == false) {
          result.putResult(
              SGIDataCommandConstants.COM_DATA_PICKUP_INDICES,
              SGPropertyResults.INVALID_INPUT_VALUE);
          return false;
        }
      ...
      result.putResult(
          SGIDataCommandConstants.COM_DATA_PICKUP_INDICES, SGPropertyResults.SUCCEEDED);
    } else if (SGIDataCommandConstants.COM_DATA_PICKUP_START.equalsIgnoreCase(key)) {
      if (SGDataUtility.isNetCDFData(this.mData)) {
  ...
  protected boolean setProperties(
    ...
    if (SGDataUtility.isMDArrayData(this.mData)) {
      ...
      String strPickUpDimension =
          map.getValueString(SGIDataCommandConstants.COM_DATA_PICKUP_DIMENSION);
    ...
    if (!"".equals(strPickUpStart)) {
      if (!this.setPickUpIndices(
          map, result, SGIDataCommandConstants.COM_DATA_PICKUP_START, strPickUpStart, pickUpMap)) {
        return false;
      }
    }
    ...
    if (!"".equals(strPickUpEnd)) {
      if (!this.setPickUpIndices(
          map, result, SGIDataCommandConstants.COM_DATA_PICKUP_END, strPickUpEnd, pickUpMap)) {
        return false;
      }
    }
    ...
    if (!"".equals(strPickUpStep)) {
      if (!this.setPickUpIndices(
          map, result, SGIDataCommandConstants.COM_DATA_PICKUP_STEP, strPickUpStep, pickUpMap)) {
        return false;
      }
    }
  ...
  private void setPickUpResults(
    ...
    List<String> keys = map.getKeys();
    if (start != null
        && keys.contains(SGIDataCommandConstants.COM_DATA_PICKUP_START.toUpperCase())) {
  ...
  public SGPropertyMap getCommandPropertyMap(SGExportParameter params) {
    ...
    if (SGDataUtility.isSDArrayData(data)) {
      ...
      if (samplingRate != null) {
        SGPropertyUtility.addProperty(
            map, SGIDataCommandConstants.COM_DATA_SAMPLING_RATE, samplingRate);
      }
    }

    // axes
    SGPropertyUtility.addProperty(
        map, SGIDataCommandConstants.COM_DATA_AXIS_X, this.getXAxisString());
    SGPropertyUtility.addProperty(
        map, SGIDataCommandConstants.COM_DATA_AXIS_Y, this.getYAxisString());
    ...
    if (SGDataUtility.isMDArrayData(data)) {
      ...
      if (pickUpStr != null) {
        SGPropertyUtility.addProperty(
            map, SGIDataCommandConstants.COM_DATA_PICKUP_DIMENSION, pickUpStr);
      }
    }
    ...
    if (lineColorCommon != null) {
      SGPropertyUtility.addProperty(
          map, SGIDataCommandConstants.COM_DATA_LINE_COLOR, lineColorCommon);
    }
  ...
  public String createCommandString(SGExportParameter params) {
    ...
    if (lineWidthCommon == null || lineTypeCommon == null || lineColorCommon == null) {
      ...
      while (cItr.hasNext()) {
        ...
        if (lineColorCommon == null) {
          SGPropertyUtility.addProperty(
              cMap, SGIDataCommandConstants.COM_DATA_LINE_COLOR, lineStyle.getColor());
        }
