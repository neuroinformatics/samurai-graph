...
public class SGXYSimpleDoubleValueIndexBlock extends SGSimpleDoubleValueIndexBlock {
  ...
  public SGXYSimpleDoubleValueIndexBlock(
      final double[] values, SGIntegerSeries colSeries, SGIntegerSeries rowSeries) {
  ...
  public static Double getDataViewerValue(
      List<SGXYSimpleDoubleValueIndexBlock> blockList, final int row, final int col) {
