...
class SGDataSetManager
  ...
  public static final String ERRMSG_FAILED_TO_CREATE_DATASET =
      "Cannot create a data set with data in use.";
   ...
   * @return
   */
  boolean loadDataSetFromEventDispatchThread(final SGDrawingWindow wnd, final File archiveFile) {
