...
public class SGLineAndStringConstants {
  ...
  // Horizontal Axis
  public static final String DEFAULT_HORIZONTAL_AXIS = SGFigureElementAxisConstants.AXIS_BOTTOM;

  // Vertical Axis
  public static final String DEFAULT_VERTICAL_AXIS = SGFigureElementAxisConstants.AXIS_LEFT;
