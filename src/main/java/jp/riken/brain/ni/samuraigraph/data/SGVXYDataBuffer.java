...
public class SGVXYDataBuffer extends SGOneDimensionalDataBuffer {
  ...
  public SGVXYDataBuffer(
      double[] xValues, double[] yValues, double[] fValues, double[] sValues, final boolean polar) {
    super();
  ...
  public String getGridTypeKey() {
    return SGDataInformationKeyConstants.KEY_VXY_GRID_PLOT_FLAG;
  }
