...
public class SGElementGroupErrorBarInGraph extends SGElementGroupErrorBarForData
  ...
  public SGElementGroupErrorBarInGraph(SGISXYTypeSingleData data, SGFigureElementGraph graph) {
    super(data);
    this.mGraph = graph;
  ...
  public SGElementGroupErrorBarInGraph(SGISXYTypeMultipleData data, SGFigureElementGraph graph) {
    super(data);
    this.mGraph = graph;
    final int num = (data != null) ? data.getPointsNumber() : 0;
    this.initDrawingElement(num);
   ...
   *
   * @param num the number of drawing elements
   */
