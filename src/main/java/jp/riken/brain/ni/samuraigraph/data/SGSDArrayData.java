...
public abstract class SGSDArrayData extends SGArrayData
   ...
   */
  public SGSDArrayData(
      final SGSDArrayFile dataFile, final SGDataSourceObserver obs, final boolean strideAvailable) {
  ...
  public abstract static class SDArrayDataProperties extends ArrayDataProperties {
  ...
  protected abstract Object[][] getDataFileExportValues(
