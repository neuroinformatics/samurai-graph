 ...
 */
public abstract class SGElementGroup implements SGIVisible, SGIDisposable {
  ...
  /** */
  public abstract boolean paintElement(final Graphics2D g2d, final Rectangle2D clipRect);
