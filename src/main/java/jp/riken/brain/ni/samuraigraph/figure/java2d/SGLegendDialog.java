...
public class SGLegendDialog extends SGPropertyDialog
  ...
  private boolean initProperty() {
    ...
    SGComponentGroupElement[] spanComponents = {
      new SGComponentGroupElement(this.mSpanLabel), new SGComponentGroupElement(this.mSpanSpinner)
    };
  ...
  public void stateChanged(final ChangeEvent e) {
    ...
    if (source == this.mBackgroundTransparencySpinner) {
      if (null != this.getBackgroundTransparency()) {
        this.setBackgroundTransparentComponentEnabled(
            Integer.valueOf(this.getBackgroundTransparency().intValue()));
      }
    }
