...
/** */
public abstract class SGDrawingElementBar2D extends SGDrawingElementBar
  ...
  /** */
  public SGDrawingElementBar2D(final float x, final float y, final float w, final float h) {
    super();
