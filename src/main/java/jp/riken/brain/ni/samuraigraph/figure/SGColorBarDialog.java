...
public class SGColorBarDialog extends SGAxisDialog
  ...
  private void initComponents() {
    ...
    mColorBarRenderParentPanel.setBorder(
        javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    mColorBarRenderParentPanel.setPreferredSize(new java.awt.Dimension(200, 20));
    mColorBarRenderParentPanel.setLayout(
        new javax.swing.BoxLayout(mColorBarRenderParentPanel, javax.swing.BoxLayout.LINE_AXIS));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
  ...
  private void initProperty() {
    ...
    this.mBarWidthSpinner.initProperties(
        new SpinnerNumberModel(
            10.0, COLOR_BAR_WIDTH_MIN, COLOR_BAR_WIDTH_MAX, COLOR_BAR_WIDTH_STEP),
        COLOR_BAR_SIZE_UNIT,
        COLOR_BAR_SIZE_FRAC_DIFIT_MIN,
        COLOR_BAR_SIZE_FRAC_DIFIT_MAX);

    // length
    this.mBarLengthSpinner.initProperties(
        new SpinnerNumberModel(
            10.0, COLOR_BAR_LENGTH_MIN, COLOR_BAR_LENGTH_MAX, COLOR_BAR_LENGTH_STEP),
        COLOR_BAR_SIZE_UNIT,
        COLOR_BAR_SIZE_FRAC_DIFIT_MIN,
        COLOR_BAR_SIZE_FRAC_DIFIT_MAX);
    ...
    this.mDateXComponentGroup.addElement(new SGComponentGroupElement(this.mXDateButton));
    this.mDateYComponentGroup.addElement(new SGComponentGroupElement(this.mYDateButton));
  ...
  public boolean setDialogProperty() {
    ...
    for (String colorMapName : colorMapNames) {
      ...
      if (this.mPropertyDialogObserverList.size() == 1) {
        SGIColorBarDialogObserver obs =
            (SGIColorBarDialogObserver) this.mPropertyDialogObserverList.get(0);
