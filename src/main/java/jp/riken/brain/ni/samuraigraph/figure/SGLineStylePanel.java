...
public class SGLineStylePanel extends javax.swing.JPanel
  ...
  private void initComponents() {
    ...
    mColorMapRenderParentPanel.setBorder(
        javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    mColorMapRenderParentPanel.setPreferredSize(new java.awt.Dimension(200, 20));
    mColorMapRenderParentPanel.setLayout(
        new javax.swing.BoxLayout(mColorMapRenderParentPanel, javax.swing.BoxLayout.LINE_AXIS));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    gridBagConstraints.gridy = 2;
  ...
  public static final String[] COLUMN_NAME_ARRAY = {
    COLUMN_NAME_NUMBER,
    COLUMN_NAME_NAME,
    COLUMN_NAME_LINE_COLOR,
    COLUMN_NAME_LINE_WIDTH,
  ...
  private void initProperty() {
    ...
    TableColumn lineTypeCol = this.mTable.getColumnModel().getColumn(colIndexLineType);
    ...
    TableColumn lineWidthCol = this.mTable.getColumnModel().getColumn(colIndexLineWidth);
    ...
    TableColumn lineColorCol = this.mTable.getColumnModel().getColumn(colIndexLineColor);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (source.equals(this.mAssignColorsButton)) {
      ...
      final List<SGLineStyle> lineStyleList =
          SGUtilityForFigureElement.createLineStyleList(this.mColorMap, num);
  ...
  class LineWidthCellEditor extends SGSpinner
      implements TableCellEditor, ActionListener, DocumentListener {
  ...
  protected class LineStyleTableModel extends DefaultTableModel {
    ...
    protected void addLineStyle(int index, SGLineStyle lineStyle) {
      ...
      Object[] array = {index + 1, "", lineStyle.getColor(), lineStyle.getLineWidth(), strLineType};
      super.addRow(array);
    }
  ...
  public void mouseClicked(MouseEvent e) {
    ...
    if (source.equals(this.mTable)) {
      ...
      if (col == this.getColumnIndex(COLUMN_NAME_LINE_COLOR)) {
        ...
        SGUtility.showColorSelectionDialog(
            this.mColorDialog, this.mColorSelectionButton, color, x, y);
      }
    }
  }
