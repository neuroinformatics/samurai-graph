...
public class SGGradationPaint extends SGTransparentPaint implements SGIDisposable {
  ...
  public static final String[] ORDER_NAMES = {
    NAME_ORDER_COLOR_1_2, NAME_ORDER_COLOR_2_1, NAME_ORDER_COLOR_1_2_1, NAME_ORDER_COLOR_2_1_2
  };

  public static final int[] ORDER_INDEX = {
    INDEX_ORDER_COLOR_1_2, INDEX_ORDER_COLOR_2_1, INDEX_ORDER_COLOR_1_2_1, INDEX_ORDER_COLOR_2_1_2
  };
   ...
   * @return
   */
  private static Paint getLinearGradientPaint(
  ...
  public SGPropertyMap getPropertyFileMap() {
    ...
    SGPropertyUtility.addProperty(
        map, KEY_GRADATION_COLOR1, SGUtilityText.getColorString(colors[0]));
    SGPropertyUtility.addProperty(
        map, KEY_GRADATION_COLOR2, SGUtilityText.getColorString(colors[1]));
    SGPropertyUtility.addProperty(
        map, KEY_GRADATION_DIRECTION, SGGradationPaint.getDirectionName(this.getDirectionIndex()));
    SGPropertyUtility.addProperty(
        map, KEY_GRADATION_ORDER, SGGradationPaint.getOrderName(this.getOrderIndex()));
    return map;
  }
}
