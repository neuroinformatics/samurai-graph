...
/**
 * The class of CheckBox which has the "indeterminate" property. If this object is in the
 * "indeterminate" state, it is neither selected nor unselected. Note that the method isSelected,
 * which is inherited from the super class JCheckBox, returns false in the indeterminate state.
 */
