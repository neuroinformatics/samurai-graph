...
public abstract class SGArrayData extends SGData {
   ...
   */
  public SGArrayData(SGIDataSource src, SGDataSourceObserver obs, final boolean strideAvailable) {
    this(src, obs);
  ...
  public abstract static class ArrayDataProperties extends DataProperties {
  ...
  public boolean writeProperty(Element el, SGExportParameter type) {
    el.setAttribute(KEY_ARRAY_SECTION_AVAILABLE, Boolean.toString(this.mStrideAvailable));
    return true;
  }
