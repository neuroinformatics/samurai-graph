...
public abstract class SGDataPopupMenu extends SGPopupMenu implements SGILegendConstants {
  ...
  public SGDataPopupMenu(
      final SGDrawingWindow wnd, final SGElementGroupSetForData gs, final boolean inGraph) {
    super();
    if (gs == null) {
  ...
  protected static class PopupMenuItem {
    ...
    PopupMenuItem(final String text, String cmd, ActionListener l, final boolean enabled) {
      super();
      this.text = text;
      this.cmd = cmd;
      this.listener = l;
  ...
  static class CheckBoxPopupMenuItem extends PopupMenuItem {
    ...
    CheckBoxPopupMenuItem(
        final String cmd, ActionListener l, final boolean itemEnabled, final boolean selected) {
