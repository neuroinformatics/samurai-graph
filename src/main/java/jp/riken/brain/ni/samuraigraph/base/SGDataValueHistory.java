...
public abstract class SGDataValueHistory implements Cloneable {
  ...
  protected SGDataValueHistory(
      final double value, final String columnType, final int col, final int row) {
    super();
    this.mValue = value;
  ...
  protected SGDataValueHistory(final double value, final String columnType, final int index) {
  ...
  public abstract static class SDArray extends SGDataValueHistory {

    public SDArray(final double value, final String columnType, final int index) {
      super(value, columnType, index);
    }

    protected SDArray(final double value, final String columnType, final int col, final int row) {
    ...
    public static class D1 extends SDArray implements ISingleDimension {
      ...
      public D1(final double value, final String columnType, final int index) {
        super(value, columnType, index);
      }

      public D1(
          final double value, final String columnType, final int index, final double prevValue) {
    ...
    public static class MD1 extends SDArray implements IMultiple {
      ...
      public MD1(final double value, String columnType, final int childIndex, final int index) {
  ...
  public abstract static class NetCDF extends SGDataValueHistory {
    ...
    public NetCDF(
        final double value, String columnType, final int col, final int row, String varName) {
      super(value, columnType, col, row);
    ...
    public static class D1 extends NetCDF implements ISingleDimension {
      ...
      public D1(final double value, final String columnType, final int index, String varName) {
  ...
  public abstract static class MDArray extends SGDataValueHistory {
    ...
    public MDArray(final double value, final String columnType, final int index, String varName) {
