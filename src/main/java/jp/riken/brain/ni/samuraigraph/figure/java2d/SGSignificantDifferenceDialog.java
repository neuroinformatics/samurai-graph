...
public class SGSignificantDifferenceDialog extends SGPropertyDialog
  ...
  /** */
  @Override
  public List<jp.riken.brain.ni.samuraigraph.base.SGColorSelectionButton>
      getColorSelectionButtonsList() {
  ...
  public List<javax.swing.JTextField> getTextFieldComponentsList() {
    final List<javax.swing.JTextField> list =
        new ArrayList<>(this.getFormattedTextFieldsListFromSpinners());
