...
class SGMainFunctionsTransform {
      ...
      if (dg instanceof SGDataTypeWizardDialog) {
        ...
        if (dataFileType == FILE_TYPE.TXT_DATA) {
          ...
          if (this.makeTransition(
                  ...
                  (SGSDArrayData) this.mTransformedData.data,
                  dataType,
                  infoMap)
              == false) {
            return false;
          ...
          if (this.makeTransition(
                  ...
                  (SGNetCDFData) this.mTransformedData.data,
                  dataType,
                  infoMap)
              == false) {
            return false;
          ...
          if (this.makeTransition(
                  ...
                  (SGMDArrayData) this.mTransformedData.data,
                  dataType,
                  infoMap)
              == false) {
            return false;
  ...
  private boolean makeTransition(
    ...
    SGDataColumnInfoSet colInfoSet =
        this.createColumnInfoList(data.getDataFile(), dataType, infoMap);
    if (colInfoSet == null) {
      return false;
    }
  ...
  private boolean makeTransition(
    ...
    // creates column information set
    SGDataColumnInfoSet colInfoSet = this.createColumnInfoList(data, dataType, infoMap);
    if (colInfoSet == null) {
      return false;
    }
  ...
  private SGDataColumnInfoSet createColumnInfoList(
      SGSDArrayFile f, String dataType, Map<String, Object> infoMap) {
  ...
  private SGDataColumnInfoSet createColumnInfoList(
      SGNetCDFData data, String dataType, Map<String, Object> infoMap) {
  ...
  private SGDataColumnInfoSet createColumnInfoList(
      SGMDArrayData data, String dataType, Map<String, Object> infoMap) {
  ...
  private boolean addDataByTransformation(SGWizardDialog dg) {
    ...
    if (dg.equals(this.mSDArrayDataSetupWizardDialog) || dataFileType == FILE_TYPE.TXT_DATA) {
      ...
      if (addNetCDFDataByTransformation(wnd, figureID, fig, data, dg) == false) {
        ...
        || dataFileType == FILE_TYPE.MATLAB_DATA) {
      // HDF5 data
      if (addMDArrayDataByTransformation(
              wnd,
              figureID,
              fig,
              data,
  ...
  private boolean addSDArrayDataByTransformation(
    ...
    return this.mMain.addDataToDrawGraph(
        wnd, figureID, null, true, infoMap, null, fig, cdSet, dataName, true);
  }
  ...
  private boolean addNetCDFDataByTransformation(
    ...
    if (dg.equals(this.mDataTypeWizardDialog)) {
      ...
      if (SGMainFunctions.addDimensionValuesToInfoMap(infoMap, this.mNetCDFDataSetupWizardDialog)
          == false) {
        return false;
      }
    }
