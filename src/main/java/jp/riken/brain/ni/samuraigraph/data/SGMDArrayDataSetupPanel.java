...
public class SGMDArrayDataSetupPanel extends SGDataSetupPanel
    implements SGSliderPanel.ISliderChangeListener, ItemListener, DocumentListener {
  ...
  private void initComponents() {
    ...
    mVXYDataSecondVariableDimensionXComboBox =
        new jp.riken.brain.ni.samuraigraph.base.SGComboBox<>();
    mVXYDataSecondVariableDimensionYLabel = new javax.swing.JLabel();
    mVXYDataSecondVariableDimensionYComboBox =
        new jp.riken.brain.ni.samuraigraph.base.SGComboBox<>();
    ...
    mSXYZDataZVariableDimensionIndexComboBox =
        new jp.riken.brain.ni.samuraigraph.base.SGComboBox<>();
    ...
    mDataColumnSelectionPanel =
        new jp.riken.brain.ni.samuraigraph.data.SGMDArrayDataColumnSelectionPanel();
    ...
    mSXYZDataXStridePanel.setBorder(
    ...
    mSXYZDataYStridePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Y",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mSXYZDataIndexStridePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Index",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataXStridePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "X",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataYStridePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Y",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataIndexStridePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Index",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mSXYDataLineAndBarStridePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Line and Bar",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mSXYDataTickLabelStrideParentPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Tick Label",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataFirstVariablePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "First Variable",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataFirstVariableDimensionGridPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Grid",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataFirstVariableDimensionGridPanel.add(
        mVXYDataFirstVariableDimensionXLabel, gridBagConstraints);
    ...
    mVXYDataFirstVariableDimensionGridPanel.add(
        mVXYDataFirstVariableDimensionXComboBox, gridBagConstraints);
    ...
    mVXYDataFirstVariableDimensionGridPanel.add(
        mVXYDataFirstVariableDimensionYLabel, gridBagConstraints);
    ...
    gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 4);
    mVXYDataFirstVariableDimensionGridPanel.add(
        mVXYDataFirstVariableDimensionYComboBox, gridBagConstraints);
    ...
    mVXYDataFirstVariableDimensionScatterPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Scatter",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataFirstVariableDimensionScatterPanel.add(
        mVXYDataFirstVariableDimensionIndexComboBox, gridBagConstraints);
    ...
    mVXYDataXVariablePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "X Coordinate",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataYVariablePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Y Coordinate",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataSecondVariablePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Second Variable",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mVXYDataSecondVariableDimensionGridPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Grid",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    gridBagConstraints.gridy = 0;
    gridBagConstraints.insets = new java.awt.Insets(2, 8, 2, 4);
    mVXYDataSecondVariableDimensionGridPanel.add(
        mVXYDataSecondVariableDimensionXLabel, gridBagConstraints);
    ...
    gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 4);
    mVXYDataSecondVariableDimensionGridPanel.add(
        mVXYDataSecondVariableDimensionXComboBox, gridBagConstraints);
    ...
    gridBagConstraints.insets = new java.awt.Insets(2, 10, 2, 4);
    mVXYDataSecondVariableDimensionGridPanel.add(
        mVXYDataSecondVariableDimensionYLabel, gridBagConstraints);
    ...
    gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 4);
    mVXYDataSecondVariableDimensionGridPanel.add(
        mVXYDataSecondVariableDimensionYComboBox, gridBagConstraints);
    ...
    mVXYDataSecondVariableDimensionScatterPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Scatter",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 2);
    mVXYDataSecondVariableDimensionScatterPanel.add(
        mVXYDataSecondVariableDimensionIndexComboBox, gridBagConstraints);
    ...
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    gridBagConstraints.insets = new java.awt.Insets(4, 0, 0, 0);
    mVXYDataSecondVariablePanel.add(
        mVXYDataSecondVariableDimensionScatterPanel, gridBagConstraints);
    ...
    mSXYZDataZVariablePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Z",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mSXYZDataZVariableDimensionGridPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Grid",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 4);
    mSXYZDataZVariableDimensionGridPanel.add(
        mSXYZDataZVariableDimensionXComboBox, gridBagConstraints);
    ...
    gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 4);
    mSXYZDataZVariableDimensionGridPanel.add(
        mSXYZDataZVariableDimensionYComboBox, gridBagConstraints);
    ...
    mSXYZDataZVariableDimensionScatterPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Scatter",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    gridBagConstraints.insets = new java.awt.Insets(2, 0, 2, 2);
    mSXYZDataZVariableDimensionScatterPanel.add(
        mSXYZDataZVariableDimensionIndexComboBox, gridBagConstraints);
    ...
    mSXYZDataXVariablePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "X",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mSXYZDataYVariablePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            null,
            "Y",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    mOriginScrollPane.setHorizontalScrollBarPolicy(
  ...
  private jp.riken.brain.ni.samuraigraph.data.SGMDArrayDataColumnSelectionPanel
      mDataColumnSelectionPanel;
  ...
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<String>
      mSXYZDataXVariableDimensionComboBox;
  ...
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<String>
      mSXYZDataYVariableDimensionComboBox;
  ...
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<String>
      mSXYZDataZVariableDimensionXComboBox;
  private javax.swing.JLabel mSXYZDataZVariableDimensionXLabel;
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<String>
      mSXYZDataZVariableDimensionYComboBox;
  ...
  private void initProperty() {
    ...
    Component[] sxyzDimensionScatterComponentArray = {
      this.mSXYZDataZVariableDimensionIndexComboBox, this.mSXYZDataIndexStridePanel
    };
    ...
    Map<Component, SGComponentGroupElement> compMap =
        new HashMap<Component, SGComponentGroupElement>();
    ...
    List<SGComponentGroupElement> tickLabelStrideComponents =
        new ArrayList<SGComponentGroupElement>();
  ...
  public boolean checkSelectedItems() {
    ...
    if (SGDataDataTypeUtility.isSXYTypeData(this.mDataType)) {
      ...
      if (SGDataFileUtility.checkMDArrayDataColumns(
              colsMD, this.mDataType, this.mMDFile, infoMap, errmsgBuffer)
          == false) {
      ...
      infoMap.put(SGDataInformationKeyConstants.KEY_SXYZ_GRID_PLOT_FLAG, gridPlot);
      ...
      if (dimZX != null && dimZY != null) {
        if (dimZX.equals(dimZY)) {
          selectionPanel.setMessage(SGDataMiscUtility.MSG_UNIQUE_DIMENSIONS);
          return false;
        }
      }
      ...
      if (zCol != null) {
        ...
        if (dimZX != null && dimX != null) {
          if (!this.compareDimensionLength(dimZX, zDims, dimX, X_VALUE, colsMD)) {
            selectionPanel.setMessage(SGDataMiscUtility.MSG_DIMENSIONS_SAME_LENGTH);
            return false;
          }
        }
      ...
      infoMap.put(SGDataInformationKeyConstants.KEY_VXY_GRID_PLOT_FLAG, gridPlot);
      ...
      final String first = SGDataStrideUtility.getVXYFirstComponentColumnType(this.mInfoMap);
      final String second = SGDataStrideUtility.getVXYSecondComponentColumnType(this.mInfoMap);
  ...
  private boolean compareDimensionLength(
      Object objZ, int[] zDims, Object obj, String key, SGMDArrayDataColumnInfo[] colsMD) {
  ...
  public int[] getOrigins(final String name) {
    SGMDArrayDataColumnInfo mdInfo =
        (SGMDArrayDataColumnInfo) this.mDataColumnSelectionPanel.findDataColumnInfo(name);
    ...
    if (SGDataDataTypeUtility.isSXYTypeData(this.mDataType)) {
      ...
      if (pickUpColList != null && pickUpColList.size() != 0) {
        ...
        for (SGMDArrayDataColumnInfo pickUpCol : pickUpColList) {
          ...
          Integer index = pickUpCol.getDimensionIndex(KEY_SXY_PICKUP_DIMENSION);
        ...
        if (dimLen != -1) {
          ...
          SGIntegerSeries series = SGDataStrideUtility.createDefaultStepSeries(dimLen);
      ...
      if (xyDimLen != -1 && xyDimLenValid) {
        ...
        if (lenOld != xyDimLen) {
          Map<String, SGIntegerSeriesSet> strideMap =
              SGDataStrideUtility.calcMDArrayDefaultStride(cols, this.mInfoMap);
          SGIntegerSeriesSet indices = strideMap.get(SGDataInformationKeyConstants.KEY_SXY_STRIDE);
      ...
      if (xInfo != null) {
        ...
        xIndex = xInfo.getDimensionIndex(KEY_GENERIC_DIMENSION);
        if (xIndex == null) {
          xIndex = 0;
        }
        if (xIndex != -1) {
          ...
          this.mDataColumnSelectionPanel.setDimensionIndex(
              xInfo.getName(), KEY_GENERIC_DIMENSION, xIndex);
        }
      }
      Integer yIndex = null;
      if (yInfo != null) {
        ...
        yIndex = yInfo.getDimensionIndex(KEY_GENERIC_DIMENSION);
        if (yIndex == null) {
          yIndex = 0;
        }
        if (yIndex != -1) {
          ...
          this.mDataColumnSelectionPanel.setDimensionIndex(
              yInfo.getName(), KEY_GENERIC_DIMENSION, yIndex);
        }
      }
      ...
      if (this.isSXYZGridPlotSelected()) {
        ...
        if (zInfo != null) {
          ...
          if (dims.length >= 2) {
            ...
            this.mDataColumnSelectionPanel.setDimensionIndex(
                zInfo.getName(), KEY_SXYZ_X_DIMENSION, zxIndex);
            ...
            this.mDataColumnSelectionPanel.setDimensionIndex(
                zInfo.getName(), KEY_SXYZ_Y_DIMENSION, zyIndex);
          }
        }
      ...
      if (this.isVXYGridPlotSelected()) {
          ...
          if (dims.length >= 2) {
            ...
            if (this.isValidDimensionIndex(fxIndex)) {
              this.setSelectedItem(
                  this.mVXYDataFirstVariableDimensionXComboBox, fxIndex.toString());
              this.mDataColumnSelectionPanel.setDimensionIndex(
                  fInfo.getName(), KEY_VXY_X_DIMENSION, fxIndex);
            }
            if (this.isValidDimensionIndex(fyIndex)) {
              this.setSelectedItem(
                  this.mVXYDataFirstVariableDimensionYComboBox, fyIndex.toString());
              this.mDataColumnSelectionPanel.setDimensionIndex(
                  fInfo.getName(), KEY_VXY_Y_DIMENSION, fyIndex);
            }
          }
        }
        ...
        if (sInfo != null) {
          ...
          if (dims.length >= 2) {
            ...
            if (this.isValidDimensionIndex(sxIndex)) {
              this.setSelectedItem(
                  this.mVXYDataSecondVariableDimensionXComboBox, sxIndex.toString());
              this.mDataColumnSelectionPanel.setDimensionIndex(
                  sInfo.getName(), KEY_VXY_X_DIMENSION, sxIndex);
            }
            if (this.isValidDimensionIndex(syIndex)) {
              this.setSelectedItem(
                  this.mVXYDataSecondVariableDimensionYComboBox, syIndex.toString());
              this.mDataColumnSelectionPanel.setDimensionIndex(
                  sInfo.getName(), KEY_VXY_Y_DIMENSION, syIndex);
            }
          }
        }
        ...
        if (xInfo != null) {
          ...
          if (fInfo != null && sInfo != null) {
            if (this.isValidDimensionIndex(fxIndex)
                && this.isValidDimensionIndex(sxIndex)
                && fxIndex != null
                && sxIndex != null) {
        ...
        if (yInfo != null) {
          ...
          if (fInfo != null && sInfo != null) {
            ...
            final int[] sDims = sInfo.getDimensions();
            if (this.isValidDimensionIndex(fyIndex)
                && this.isValidDimensionIndex(syIndex)
                && fyIndex != null
                && syIndex != null) {
  ...
  private void equalizeTimeDimension(SGDataColumnInfo[] cols) {
    ...
    final int fIndex = SGDataColumnInfoUtility.findFrequentTimeOrigin(cols);
    if (fIndex == -1) {
      return;
    }
  ...
  private void updateDimensionPanelsEnabled(final int dataColumnIndex) {
    ...
    if (SGDataDataTypeUtility.isSXYTypeData(this.mDataType)) {
      Integer generic = info.getDimensionIndex(KEY_GENERIC_DIMENSION);
      if (generic != null) {
        disabledDimList.add(generic.toString());
      }
      Integer pickUp = info.getDimensionIndex(KEY_SXY_PICKUP_DIMENSION);
      if (pickUp != null) {
   ...
   *
   * @param data multidimensional data
  ...
  public boolean setData(
    ...
    if (this.setData(
            (SGMDArrayFile) data.getDataSource(),
            data.getDataType(),
            colInfoSet,
            infoMap,
            showDefault)
   ...
   *
   * @param mdFile the multidimensional data file
  ...
  public boolean setData(
    ...
    // check input values
    if (mdFile == null || dataType == null || colInfoSet == null || infoMap == null) {
    ...
    final boolean isSXY = SGDataDataTypeUtility.isSXYTypeData(dataType);
  ...
  private void initPickUpStridePanel(final Map<String, Object> infoMap) {
    ...
    if (dimensionIndexMap != null) {
      ...
      for (Map.Entry<?, ?> entry : dimensionIndexMap.entrySet()) {
        ...
        if (this.isValidDimensionIndex(index)) {
          SGMDArrayDataColumnInfo mdCol =
              (SGMDArrayDataColumnInfo) SGDataColumnInfoUtility.findColumnWithName(cols, name);
      ...
      SGMDArrayDataColumnInfo pickUpCol =
          (SGMDArrayDataColumnInfo)
              SGDataColumnInfoUtility.findColumnWithName(cols, pickUpDimension);
      int[] dims = pickUpCol.getDimensions();
  ...
  /**
   * Called whenever the value of the selection changes. This method is overrode for the selection
   * of table rows.
   *
   ...
   *
   * @param p a dimension panel that has the slider
   */
  @Override
  ...
  private void onItemSelected(final JComboBox<?> source, final Object item) {
    ...
    if (SGDataDataTypeUtility.isSXYZTypeData(this.mDataType)) {
      ...
      if (this.isVXYGridPlotSelected()) {
        ...
        if (xInfo != null) {
          ...
          if (fInfo != null && sInfo != null) {
            this.updateIndexPanel(
                cols,
                new SGDataColumnInfo[] {fInfo, sInfo},
                this.mVXYDataXStridePanel,
                SGDataInformationKeyConstants.KEY_VXY_STRIDE_X,
                KEY_VXY_X_DIMENSION);
          }
  ...
  private void setupVXYStrideLength(
      SGMDArrayDataColumnInfo fInfo, SGMDArrayDataColumnInfo sInfo, String key, SGIndexPanel p) {
    final int[] fDims = fInfo.getDimensions();
    final int[] sDims = sInfo.getDimensions();
  ...
  private boolean updateIndexPanel(
      SGDataColumnInfo[] cols,
      List<SGDataColumnInfo> colList,
      SGIndexPanel indexPanel,
      String key) {
    int dimLen = -1;
    ...
    if (dimLen != -1 && dimLenValid) {
      ...
      if (lenOld != dimLen) {
        Map<String, Object> infoMap = new HashMap<String, Object>(this.mInfoMap);
        infoMap.put(
            SGDataInformationKeyConstants.KEY_SXYZ_GRID_PLOT_FLAG, this.isSXYZGridPlotSelected());
        infoMap.put(
            SGDataInformationKeyConstants.KEY_VXY_GRID_PLOT_FLAG, this.isVXYGridPlotSelected());
        Map<String, SGIntegerSeriesSet> strideMap =
  ...
  private void itemStateChangedSub(
      String columnType, Object item, String key, final boolean equals) {
  ...
  public Map<String, Integer> getTimeDimensionIndexMap() {
    ...
    for (int ii = 0; ii < cols.length; ii++) {
      SGMDArrayDataColumnInfo mdCol = (SGMDArrayDataColumnInfo) cols[ii];
      String name = mdCol.getName();
      Integer index = mdCol.getDimensionIndex(KEY_TIME_DIMENSION);
      map.put(name, index);
    }
    return map;
  }
  ...
  private List<SGMDArrayDataColumnInfo> findValidPickUpXYColumns() {
    SGDataColumnInfo[] cols = this.getDataColumnInfoArray();
    return SGDataColumnInfoUtility.findValidPickUpXYColumns(cols);
  }
  ...
  private void initStride() {
    ...
    if (SGDataDataTypeUtility.isSXYTypeData(this.mDataType)) {
      SGIntegerSeriesSet stride =
          (SGIntegerSeriesSet) this.mInfoMap.get(SGDataInformationKeyConstants.KEY_SXY_STRIDE);
      final int len;
      if (stride == null) {
        Map<String, SGIntegerSeriesSet> strideMap =
            SGDataStrideUtility.calcMDArrayDefaultStride(cols, this.mInfoMap, dimNameMap);
        SGMDArrayDimensionInfo dimInfo =
            dimNameMap.get(SGDataInformationKeyConstants.KEY_SXY_STRIDE);
        String name = dimInfo.getName();
        final int dimIndex = dimInfo.getIndex();
        SGMDArrayDataColumnInfo mdInfo =
            (SGMDArrayDataColumnInfo) this.findColumnWithName(cols, name);
        len = mdInfo.getDimensions()[dimIndex];
        if (strideAvailable) {
          stride = strideMap.get(SGDataInformationKeyConstants.KEY_SXY_STRIDE);
        } else {
          stride = SGIntegerSeriesSet.createInstance(len);
        }
      } else {
        len = SGDataColumnInfoUtility.getSXYMDArrayDataLength(cols);
      ...
      if (gridPlot) {
        ...
        SGIntegerSeriesSet xStride =
            (SGIntegerSeriesSet) this.mInfoMap.get(SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_X);
        SGIntegerSeriesSet yStride =
            (SGIntegerSeriesSet) this.mInfoMap.get(SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_Y);
        Integer lenX = null;
        Integer lenY = null;
        if (xStride == null || yStride == null) {
          Map<String, SGIntegerSeriesSet> strideMap =
              SGDataStrideUtility.calcMDArrayDefaultStride(cols, infoMap, dimNameMap);
          if (xStride == null) {
            final SGMDArrayDimensionInfo dimInfoX =
                dimNameMap.get(SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_X);
            final String nameX = dimInfoX.getName();
            SGMDArrayDataColumnInfo mdInfoX =
                (SGMDArrayDataColumnInfo) this.findColumnWithName(cols, nameX);
            final int dimIndexX = dimInfoX.getIndex();
            lenX = mdInfoX.getDimensions()[dimIndexX];
            if (strideAvailable) {
              xStride = strideMap.get(SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_X);
            } else {
              xStride = SGIntegerSeriesSet.createInstance(lenX);
            }
          }
          if (yStride == null) {
            final SGMDArrayDimensionInfo dimInfoY =
                dimNameMap.get(SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_Y);
            final String nameY = dimInfoY.getName();
            SGMDArrayDataColumnInfo mdInfoY =
                (SGMDArrayDataColumnInfo) this.findColumnWithName(cols, nameY);
            final int dimIndexY = dimInfoY.getIndex();
            lenY = mdInfoY.getDimensions()[dimIndexY];
            if (strideAvailable) {
              yStride = strideMap.get(SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_Y);
            } else {
              yStride = SGIntegerSeriesSet.createInstance(lenY);
            }
          }
        } else {
          lenX = SGDataColumnInfoUtility.getSXYZMDArrayDataXLength(cols);
          lenY = SGDataColumnInfoUtility.getSXYZMDArrayDataYLength(cols);
        }
        if (lenX != null) {
        ...
        SGIntegerSeriesSet indexStride =
            (SGIntegerSeriesSet)
                this.mInfoMap.get(SGDataInformationKeyConstants.KEY_SXYZ_INDEX_STRIDE);
        Integer lenIndex = null;
        if (indexStride == null) {
          Map<String, SGIntegerSeriesSet> strideMap =
              SGDataStrideUtility.calcMDArrayDefaultStride(cols, infoMap, dimNameMap);
          final SGMDArrayDimensionInfo dimInfo =
              dimNameMap.get(SGDataInformationKeyConstants.KEY_SXYZ_INDEX_STRIDE);
          ...
          if (strideAvailable) {
            indexStride = strideMap.get(SGDataInformationKeyConstants.KEY_SXYZ_INDEX_STRIDE);
          } else {
            indexStride = SGIntegerSeriesSet.createInstance(lenIndex);
          }
        } else {
          lenIndex = SGDataColumnInfoUtility.getSXYZMDArrayDataZGenericDimensionLength(cols);
        }
        if (lenIndex != null) {
      ...
      if (gridPlot) {
        // grid plot
        SGIntegerSeriesSet xStride =
            (SGIntegerSeriesSet) this.mInfoMap.get(SGDataInformationKeyConstants.KEY_VXY_STRIDE_X);
        SGIntegerSeriesSet yStride =
            (SGIntegerSeriesSet) this.mInfoMap.get(SGDataInformationKeyConstants.KEY_VXY_STRIDE_Y);
        Integer lenX = null;
        Integer lenY = null;
        if (xStride == null || yStride == null) {
          Map<String, SGIntegerSeriesSet> strideMap =
          ...
          if (xStride == null) {
            final SGMDArrayDimensionInfo dimInfoX =
                dimNameMap.get(SGDataInformationKeyConstants.KEY_VXY_STRIDE_X);
            final String nameX = dimInfoX.getName();
            SGMDArrayDataColumnInfo mdInfoX =
                (SGMDArrayDataColumnInfo) this.findColumnWithName(cols, nameX);
            final int dimIndexX = dimInfoX.getIndex();
            lenX = mdInfoX.getDimensions()[dimIndexX];
            if (strideAvailable) {
              xStride = strideMap.get(SGDataInformationKeyConstants.KEY_VXY_STRIDE_X);
            } else {
              xStride = SGIntegerSeriesSet.createInstance(lenX);
            }
          }
          if (yStride == null) {
            final SGMDArrayDimensionInfo dimInfoY =
                dimNameMap.get(SGDataInformationKeyConstants.KEY_VXY_STRIDE_Y);
            final String nameY = dimInfoY.getName();
            SGMDArrayDataColumnInfo mdInfoY =
                (SGMDArrayDataColumnInfo) this.findColumnWithName(cols, nameY);
            final int dimIndexY = dimInfoY.getIndex();
            lenY = mdInfoY.getDimensions()[dimIndexY];
            if (strideAvailable) {
              yStride = strideMap.get(SGDataInformationKeyConstants.KEY_VXY_STRIDE_Y);
            } else {
              yStride = SGIntegerSeriesSet.createInstance(lenY);
            }
          }
        } else {
          Boolean polar = SGDataMiscUtility.isPolar(this.mInfoMap);
          lenX = SGDataColumnInfoUtility.getVXYMDArrayDataXLength(cols, polar);
          lenY = SGDataColumnInfoUtility.getVXYMDArrayDataYLength(cols, polar);
        }
        if (lenX != null) {
          xStride = SGUtility.createIndicesWithinRange(xStride, lenX);
        ...
        SGIntegerSeriesSet indexStride =
            (SGIntegerSeriesSet)
                this.mInfoMap.get(SGDataInformationKeyConstants.KEY_VXY_INDEX_STRIDE);
        Boolean polar =
            (Boolean) this.mInfoMap.get(SGDataInformationKeyConstants.KEY_VXY_POLAR_SELECTED);
        Integer lenIndex = null;
        if (indexStride == null) {
          Map<String, SGIntegerSeriesSet> strideMap =
              SGDataStrideUtility.calcMDArrayDefaultStride(cols, infoMap, dimNameMap);
          final SGMDArrayDimensionInfo dimInfo =
              dimNameMap.get(SGDataInformationKeyConstants.KEY_VXY_INDEX_STRIDE);
          final String name = dimInfo.getName();
          SGMDArrayDataColumnInfo mdInfo =
              (SGMDArrayDataColumnInfo) this.findColumnWithName(cols, name);
          final int dimIndex = dimInfo.getIndex();
          lenIndex = mdInfo.getDimensions()[dimIndex];
          if (strideAvailable) {
            indexStride = strideMap.get(SGDataInformationKeyConstants.KEY_VXY_INDEX_STRIDE);
          } else {
            indexStride = SGIntegerSeriesSet.createInstance(lenIndex);
          }
        } else {
          lenIndex =
              SGDataColumnInfoUtility.getVXYMDArrayDataComponentGenericDimensionLength(cols, polar);
        }
        if (lenIndex != null) {
          indexStride = SGUtility.createIndicesWithinRange(indexStride, lenIndex);
  ...
  private void initTickLabelStride(
    ...
    if (strideTickLabel == null) {
      ...
      if (sync) {
        ...
        lenTickLabel = SGDataColumnInfoUtility.getSXYMDArrayDataLength(cols);
      }
    }
  ...
  private void onDocumentUpdate(DocumentEvent e) {
    ...
    if (this.mSXYDataPickUpDimensionIndexPanel.hasDocument(doc)) {
      SGIntegerSeriesSet indices = this.mSXYDataPickUpDimensionIndexPanel.getIndices();
      this.mInfoMap.put(SGDataInformationKeyConstants.KEY_SXY_PICKUP_INDICES, indices);
  ...
  public Map<String, SGIntegerSeriesSet> getStrideMap() {
    ...
    if (SGDataDataTypeUtility.isSXYTypeData(this.mDataType)) {
      ...
      this.updateStrideMap(
          this.mSXYZDataXStridePanel, SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_X, strideMap);
      this.updateStrideMap(
          this.mSXYZDataYStridePanel, SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_Y, strideMap);
      this.updateStrideMap(
          this.mSXYZDataIndexStridePanel,
          SGDataInformationKeyConstants.KEY_SXYZ_INDEX_STRIDE,
          strideMap);
      ...
      this.updateStrideMap(
          this.mVXYDataXStridePanel, SGDataInformationKeyConstants.KEY_VXY_STRIDE_X, strideMap);
      this.updateStrideMap(
          this.mVXYDataYStridePanel, SGDataInformationKeyConstants.KEY_VXY_STRIDE_Y, strideMap);
      this.updateStrideMap(
          this.mVXYDataIndexStridePanel,
          SGDataInformationKeyConstants.KEY_VXY_INDEX_STRIDE,
          strideMap);
  ...
  protected Map<String, Integer> getFullLengthMap() {
    ...
    if (SGDataDataTypeUtility.isSXYTypeData(this.mDataType)) {
      ...
      this.updateLengthMap(
          this.mSXYZDataXStridePanel, SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_X, lengthMap);
      this.updateLengthMap(
          this.mSXYZDataYStridePanel, SGDataInformationKeyConstants.KEY_SXYZ_STRIDE_Y, lengthMap);
      this.updateLengthMap(
          this.mSXYZDataIndexStridePanel,
          SGDataInformationKeyConstants.KEY_SXYZ_INDEX_STRIDE,
          lengthMap);
      ...
      this.updateLengthMap(
          this.mVXYDataXStridePanel, SGDataInformationKeyConstants.KEY_VXY_STRIDE_X, lengthMap);
      this.updateLengthMap(
          this.mVXYDataYStridePanel, SGDataInformationKeyConstants.KEY_VXY_STRIDE_Y, lengthMap);
      this.updateLengthMap(
          this.mVXYDataIndexStridePanel,
          SGDataInformationKeyConstants.KEY_VXY_INDEX_STRIDE,
          lengthMap);
  ...
  private boolean isValidDimensionIndex(Integer index) {
    return SGDataDataTypeUtility.isValidDimensionIndex(index);
  }
}
