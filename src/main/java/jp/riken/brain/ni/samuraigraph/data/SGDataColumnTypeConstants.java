...
public class SGDataColumnTypeConstants {
  ...
  /** A constant for the time. (Only for backward compatibility <= 2.0.0) */
  ...
  /** A constant for the serial numbers. (Only for backward compatibility <= 2.0.0) */
  public static final String SERIAL_NUMBERS = "SerialNumbers";

  /**
   * A constant for the index for x values. Note: Procedure using this constant should be removed.
   */
  public static final String X_INDEX = "X Index";

  /**
   * A constant for the index for y values. Note: Procedure using this constant should be removed.
   */
