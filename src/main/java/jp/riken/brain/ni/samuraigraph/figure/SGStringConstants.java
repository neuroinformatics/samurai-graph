...
public class SGStringConstants {
  ...
  // Horizontal Axis
  public static final String DEFAULT_LABEL_HORIZONTAL_AXIS =
      SGFigureElementAxisConstants.AXIS_BOTTOM;

  // Vertical Axis
  public static final String DEFAULT_LABEL_VERTICAL_AXIS = SGFigureElementAxisConstants.AXIS_LEFT;
