...
public abstract class SGDrawingElementScale2D extends SGDrawingElementScale
  ...
  public void paint(final Graphics2D g2d) {
    ...
    final Shape hLineShape = ((SGDrawingElementLine2D) this.getHorizontalLine()).getLineShape();
    final Shape vLineShape = ((SGDrawingElementLine2D) this.getVerticalLine()).getLineShape();
