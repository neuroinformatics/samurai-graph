...
public abstract class SGDataSetupPanel extends JPanel
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (source.equals(this.getClearButton())
        || source.equals(this.getRestoreButton())
  ...
  protected void updateStrideMap(
      SGIndexPanel panel, String key, Map<String, SGIntegerSeriesSet> map) {
