...
public class SGLineStyleColorMapManager extends SGColorMapManager
  ...
  public static final String[] DEFAULT_COLOR_MAP_NAMES = {
    COLOR_MAP_NAME_HUE_GRADATION, COLOR_MAP_NAME_COLOR_GRAY_SCALE
  };
  ...
  public static boolean isColorAssignableType(final String name) {
    ...
    return SGUtilityText.isEqualString(
        SGLineStyleColorMapManager.COLOR_MAP_NAME_COLOR_GRAY_SCALE, name);
  }
