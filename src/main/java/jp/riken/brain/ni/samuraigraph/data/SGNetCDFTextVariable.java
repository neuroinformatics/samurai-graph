...
public class SGNetCDFTextVariable extends SGNetCDFVariable {
   ...
   * @param mod the modifier
   */
  public SGNetCDFTextVariable(
      final Variable var, final SGNetCDFFile ncfile, final SGIStringModifier mod) {
    super(var, ncfile);
    this.mModifier = mod;
  }
  ...
  /**
   * Returns the dimension that has the length of the maximum length of all text strings.
   *
