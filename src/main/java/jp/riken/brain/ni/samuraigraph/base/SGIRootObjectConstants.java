...
public final class SGIRootObjectConstants {

  /** Private constructor to prevent instantiation. */
  private SGIRootObjectConstants() {}
  ...
  public static final float DEFAULT_PAPER_WIDTH =
      (MediaSize.ISO.A4.getX(Size2DSyntax.MM) / 10.0f) / SGIConstants.CM_POINT_RATIO;

  // paper height
  public static final float DEFAULT_PAPER_HEIGHT =
      (MediaSize.ISO.A4.getY(Size2DSyntax.MM) / 10.0f) / SGIConstants.CM_POINT_RATIO;
