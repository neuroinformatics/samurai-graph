...
public class SGPropertyFileConstants {
  ...
  public static final String PROPERTY_FILE_PUBLIC_ID =
      "-//NILAB//DTD Samurai-Graph Property XML 1.0//EN";

  /** System ID of the property files. */
  public static final String PROPERTY_FILE_SYSTEM_ID =
      "http://samurai-graph.sourceforge.jp/" + PROPERTY_DTD_FILE_NAME;
