...
public class SGDrawingWindow extends JFrame
  ...
  private static final String[] IMAGE_FILENAMES_ARRAY = {
    SGIRootObjectConstants.SAMURAI_IMG_FILENAME
  };
  ...
  public void updateItemsByFigureNumbers() {
    ...
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_FILE, SGIRootObjectConstants.MENUBARCMD_EXPORT_AS_IMAGE, b);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_FILE, SGIRootObjectConstants.MENUBARCMD_SAVE_PROPERTY, b);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_FILE, SGIRootObjectConstants.MENUBARCMD_SAVE_DATASET, b);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_FILE, SGIRootObjectConstants.MENUBARCMD_PRINT, b);
    mBar.setMenuItemEnabled(
    ...
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_ARRANGE,
        SGIRootObjectConstants.MENUBARCMD_AUTO_ARRANGEMENT,
        b);
  ...
  public boolean addFigure(final SGFigure figure, final Point pos) {
    ...
    if (pos != null) {
      ...
      figure.setGraphRectLocation((float) location.getX(), (float) location.getY());
    }
   ...
   *
   * @param b true if auto zoom is to be enabled
   */
  ...
  public boolean setFigureBoundingBox(final int mode) {
    ...
    if (mode == 0 || mode == 1) {
      width =
          SGDrawingWindow.BOUNDING_BOX_MARGIN
  ...
  public SGPropertyResults setProperties(SGPropertyMap map) {
    ...
    while (itr.hasNext()) {
      ...
      if (SGIRootObjectConstants.COM_PAPER_WIDTH.equalsIgnoreCase(key)) {
        ...
        if (num == null) {
          result.putResult(
              SGIRootObjectConstants.COM_PAPER_WIDTH, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        if (num == null) {
          result.putResult(
              SGIRootObjectConstants.COM_PAPER_HEIGHT, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        result.putResult(
            SGIRootObjectConstants.COM_WINDOW_BACKGROUND_COLOR, SGPropertyResults.SUCCEEDED);
        ...
        result.putResult(
            SGIRootObjectConstants.COM_WINDOW_GRID_VISIBLE, SGPropertyResults.SUCCEEDED);
        ...
        result.putResult(
            SGIRootObjectConstants.COM_WINDOW_GRID_INTERVAL, SGPropertyResults.SUCCEEDED);
        ...
        result.putResult(
            SGIRootObjectConstants.COM_WINDOW_GRID_LINE_WIDTH, SGPropertyResults.SUCCEEDED);
        ...
        if (num == null) {
          result.putResult(
              SGIRootObjectConstants.COM_IMAGE_LOCATION_X, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        if (num == null) {
          result.putResult(
              SGIRootObjectConstants.COM_IMAGE_LOCATION_Y, SGPropertyResults.INVALID_INPUT_VALUE);
          continue;
        }
        ...
        result.putResult(
            SGIRootObjectConstants.COM_IMAGE_SCALING_FACTOR, SGPropertyResults.SUCCEEDED);
      }
    }
  ...
  protected MouseDragResult getMouseDragResult(MouseEvent e) {
    MouseDragInput params =
        new MouseDragInput(
            e, this.mTempMouseLocation, this.mDraggedDirection, this.mFixedCoordinate);
  ...
  protected boolean moveFocusedObjects(MouseEvent e) {
    ...
    this.mTempMouseLocation.setLocation(
        this.mTempMouseLocation.x + dx, this.mTempMouseLocation.y + dy);
  ...
  public boolean setPositionLabel(final int x, final int y) {
    ...
    final float ratio = SGIConstants.CM_POINT_RATIO / this.mMagnification;
    float xx = (-cx + x) * ratio;
    float yy = (-cy + y) * ratio;
  ...
  protected void updateFocusedObjectItem() {
    ...
    SGMenuBar mBar = this.mMenuBar;
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT, SGIRootObjectConstants.MENUBARCMD_CUT, eff);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT, SGIRootObjectConstants.MENUBARCMD_COPY, eff);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT, SGIRootObjectConstants.MENUBARCMD_DELETE, eff);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT, SGIRootObjectConstants.MENUBARCMD_DUPLICATE, eff);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_ARRANGE,
  ...
  public void setPasteMenuEnabled(final boolean b) {
    this.mMenuBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT, SGIRootObjectConstants.MENUBARCMD_PASTE, b);
  ...
  private void updateGridItems() {
    ...
    if (gridVisible) {
      final double interval = this.mClientPanel.getGridLineInterval() * SGIConstants.CM_POINT_RATIO;
  ...
  private void updateZoomItems() {
    ...
    SGMenuBar bar = this.mMenuBar;
    bar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_LAYOUT, SGIRootObjectConstants.MENUBARCMD_ZOOM_IN, zoomIn);
    bar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_LAYOUT, SGIRootObjectConstants.MENUBARCMD_ZOOM_OUT, zoomOut);
    bar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_LAYOUT, SGIRootObjectConstants.MENUBARCMD_DEFAULT_ZOOM, def);
    bar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_LAYOUT,
        SGIRootObjectConstants.MENUBARCMD_ZOOM_WAY_OUT,
        zoomWayOut);
  }
  ...
  private void updateBackgroundImageItems() {
    ...
    this.mMenuBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT,
        SGIRootObjectConstants.MENUBARCMD_DELETE_BACKGROUND_IMAGE,
        b);
  }
  ...
  public SGPropertyResults exportAsImage(
    ...
    SGPropertyResults result = this.mImageExportManager.export(target, type, path, map);
    if (result == null) {
  ...
  void doFitAxisRangeToVisibleData(
      final List<Integer> axisDirections, final boolean forAnimationFrames) {
    boolean changed = false;
    List<SGFigure> fList = this.getFocusedFigureList();
  ...
  private void updateLockItems() {
    ...
    this.mMenuBar.setMenuItemSelected(
        SGIRootObjectConstants.MENUBAR_LAYOUT, SGIRootObjectConstants.MENUBARCMD_LOCK, flag);
  }
  ...
  private Rectangle2D getPaperRectInClientRect() {
    Rectangle2D rect =
        new Rectangle2D.Float(
            this.mPaperOrigin.x,
            this.mPaperOrigin.y,
            this.mClientPanel.getPaperWidth(),
  ...
  static {
    ...
    final float ten =
        (float) SGUtilityNumber.getPowersOfTen(SGIRootObjectConstants.LENGTH_MINIMAL_ORDER);
  ...
  // this.mMenuBar.setMenuItemSelected(SGIRootObjectConstants.MENUBAR_LAYOUT,
  ...
  private void fitRect(Rectangle2D rect1, Rectangle2D rect2, final boolean flag) {
    if (flag) {
      ...
      rect1.setRect(rect1.getX(), rect2.getY(), rect1.getWidth(), rect2.getHeight());
    }
  }
  ...
  //
  // System.out.println("x="+x*SGIConstants.CM_POINT_RATIO+"SGIConstants.cm,
  // y="+y*SGIConstants.CM_POINT_RATIO+"SGIConstants.cm");
  // System.out.println("w="+w*SGIConstants.CM_POINT_RATIO+"SGIConstants.cm,
  // h="+h*SGIConstants.CM_POINT_RATIO+"SGIConstants.cm");
  // System.out.println();
  // }
  ...
  /**
   * Returns true if both of given figure and data exists in the state after undo/redo operation.
   *
  ...
  private void updateUndoItems() {
    ...
    SGMenuBar mBar = this.mMenuBar;
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT, SGIRootObjectConstants.MENUBARCMD_UNDO, undoEnable);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT, SGIRootObjectConstants.MENUBARCMD_REDO, redoEnable);
    mBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_EDIT,
        SGIRootObjectConstants.MENUBARCMD_CLEAR_UNDO_BUFFER,
        (undoEnable || redoEnable));
  ...
  private boolean beforeExport(
    ...
    for (int ii = 0; ii < list.size(); ii++) {
      SGFigure figure = list.get(ii);
      figure.setMode(SGIConstants.MODE_EXPORT_AS_IMAGE);
    }
  ...
  boolean createPropertyFileFromFocusedFigures() {
    this.mPropertyFileCreationModeOfFigures =
        SGIRootObjectConstants.FOCUSED_FIGURES_IN_BOUNDING_BOX;
    this.notifyToListener(SGIRootObjectConstants.MENUBARCMD_SAVE_PROPERTY);
    return true;
  }
  ...
  private boolean createDOMTreeForFocusedFiguresInBoundingBox(
    ...
    // write properties of the window
    Element windowElement = this.createElementForFocusedFiguresInBoundingBox(document, params);
    if (windowElement == null) {
      return false;
    }
    property.appendChild(windowElement);
  ...
  public boolean createElementForFocusedFiguresInBoundingBox(
    ...
    SGPropertyUtility.addProperty(
        map, SGIRootObjectConstants.KEY_PAPER_WIDTH, width, SGIRootObjectConstants.PAPER_SIZE_UNIT);
    SGPropertyUtility.addProperty(
        map,
  ...
  boolean showPopupMenuForSelectedFigures(JComponent component, final int x, final int y) {
    ...
    p.addPopupMenuListener(
        new PopupMenuListener() {
          // Adds a PopupMenuListener to refresh the attributes when popup menu becomes
          // invisible.
          @Override
    ...
    for (int ii = 0; ii < components.length; ii++) {
      if (components[ii] instanceof JMenuItem) {
        ...
        if (SGFigure.MENUCMD_LEGEND_VISIBLE.equals(command)) {
          ...
          item.setEnabled(b);
        } else if (SGIConstants.MENUCMD_ALIGN_BARS.equals(command)) {
          final boolean b =
              (alignmentBarsAvailable != null) ? alignmentBarsAvailable.booleanValue() : false;
          item.setEnabled(b);
        } else if (SGIConstants.MENUCMD_FIT_AXES_TO_DATA.equals(command)) {
    ...
    for (int ii = 0; ii < components.length; ii++) {
      if (components[ii] instanceof SGCheckBoxMenuItem) {
        ...
        } else if (com.equals(SGIRootObjectConstants.MENUBARCMD_SNAP_TO_GRID)) {
  ...
  public static class WindowProperties extends SGProperties {
    ...
    public boolean equals(final Object obj) {
      ...
      if (p.mImage != null) {
        ...
        if (this.mImage != null) return false;
      }
      return true;
    }
  ...
  public void doTransformData() {
    ...
    // notify the command
    this.notifyToListener(SGIConstants.MENUCMD_TRANSFORM_DATA);
  ...
  void doOutputDataToFile(final SGData data) {
    SGPluginsQueryMessage message =
        new SGPluginsQueryMessage(SGPluginsQueryMessage.MENUCMD_EXEC_OUTPUT_TO_FILE);
    message.set(data);
  ...
  public static class BackgroundImage {
     ...
     *
     * @param ext the extension of image file
     * @param b the byte array of the image
     */
  ...
  public SGPropertyMap getCommandPropertyMap(SGExportParameter params) {
    ...
    if (path != null) {
      SGPropertyUtility.addQuotedStringProperty(
          map, SGIRootObjectConstants.COM_IMAGE_FILE_PATH, path);
    }
    return map;
  }
  ...
  private void addProperties(
    ...
    SGPropertyUtility.addProperty(
        map,
        gridIntervalKey,
        this.getExportLengthValue(
            this.getGridLineInterval(SGIRootObjectConstants.GRID_INTERVAL_UNIT)),
        SGIRootObjectConstants.GRID_INTERVAL_UNIT);
    SGPropertyUtility.addProperty(
        map,
        gridLineWidthKey,
        SGUtility.getExportLineWidth(this.getGridLineWidth(SGIConstants.LINE_WIDTH_UNIT)),
    ...
    SGPropertyUtility.addProperty(
        ...
        imageXKey,
        this.getExportLengthValue(
            this.getImageLocationX(SGIRootObjectConstants.IMAGE_LOCATION_UNIT)),
        SGIRootObjectConstants.IMAGE_LOCATION_UNIT);
    SGPropertyUtility.addProperty(
        map,
        imageYKey,
        this.getExportLengthValue(
            this.getImageLocationY(SGIRootObjectConstants.IMAGE_LOCATION_UNIT)),
        SGIRootObjectConstants.IMAGE_LOCATION_UNIT);
    SGPropertyUtility.addProperty(
        map,
        imageScaleKey,
  ...
  public String getCommandString(SGExportParameter params) {
    ...
    String wndCommands =
        SGCommandUtility.createCommandString(
            SGIRootObjectConstants.COM_WINDOW, null, this.getCommandPropertyMap(params));
  ...
  public void setCommandMenuEnabled(final boolean commandEnabled) {
    this.mMenuBar.setMenuItemEnabled(
        SGIRootObjectConstants.MENUBAR_FILE,
        SGIRootObjectConstants.MENUBARCMD_LOAD_SCRIPT,
        commandEnabled);
  }
  ...
  void doAnimation() {
    this.notifyToListener(SGIConstants.MENUCMD_ANIMATION);
  }
