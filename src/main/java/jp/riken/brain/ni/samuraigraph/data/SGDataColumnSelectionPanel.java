...
public abstract class SGDataColumnSelectionPanel extends javax.swing.JPanel
  ...
  private void initComponents() {
    ...
    mTableScrollPane.setHorizontalScrollBarPolicy(
  ...
  SGComboBox<Object> mColumnTypeRendererComboBox = null;

  /** A combo box for table cell editor for the column type. */
  SGComboBox<String> mColumnTypeEditorComboBox = null;
  ...
  public boolean setData(
    ...
    TableColumn col = this.mTable.getColumnModel().getColumn(colIndexColumnType);
  ...
  /** A cell editor class to display items in a combo box for various data type. */
  protected class ColumnTypeCellEditor extends DefaultCellEditor {
     ...
     * @param comboBox
     */
    public ColumnTypeCellEditor(JComboBox<String> comboBox) {
      super(comboBox);
    }
  ...
  /** A cell renderer class to display items in a combo box for various data type. */
  protected class DataColumnCellRenderer extends DefaultTableCellRenderer {
    ...
    private SGComboBox<Object> mComboBox = null;
   ...
   *
   * @param evt an event that the property changes
   */
   ...
   *
   * @param owner the owner of popup dialogs
   */
  ...
  protected static class ButtonColumn extends AbstractCellEditor
  ...
  protected void setValueAt(
      final Object value, final int dataColumnIndex, final int tableColumnIndex) {
