...
/**
 * A variable class for tick labels. A variable has only one dimension and text strings for tick
 * labels.
 */
public class SGTextVariable extends SGCharVariable {
   ...
   */
  public SGTextVariable(final Variable var, final SGNetCDFFile ncfile, final String[] stringArray) {
