...
public class SGFigureElementShape extends SGFigureElement
  ...
  class Rect extends SGSimpleRectangle2D implements IElement, SGIRectangularShapeDialogObserver {
  ...
  /** A class of arrow. */
  class Arrow extends SGSimpleArrow2D implements IElement, SGIArrowDialogObserver {
