...
public abstract class SGDrawingElementArrow2D extends SGDrawingElementArrow
  ...
  public Rectangle2D getElementBounds() {
    ...
    SGDrawingElementSymbol2D start = (SGDrawingElementSymbol2D) this.getStartHead();
    SGDrawingElementSymbol2D end = (SGDrawingElementSymbol2D) this.getEndHead();
  ...
  public void paint(Graphics2D g2d) {
    ...
    final SGDrawingElementLine2D line = (SGDrawingElementLine2D) this.getLine();
    final SGDrawingElementSymbol2D start = (SGDrawingElementSymbol2D) this.getStartHead();
    final SGDrawingElementSymbol2D end = (SGDrawingElementSymbol2D) this.getEndHead();
    line.paint(g2d);
    start.paint(g2d);
    end.paint(g2d);
  }
