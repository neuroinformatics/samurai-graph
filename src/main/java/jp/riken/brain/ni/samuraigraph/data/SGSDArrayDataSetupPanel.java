...
public class SGSDArrayDataSetupPanel extends SGDataSetupPanel implements DocumentListener {
  ...
  private void initComponents() {
    ...
    mDataColumnSelectionPanel =
        new jp.riken.brain.ni.samuraigraph.data.SGSDArrayDataColumnSelectionPanel();
    ...
    mTickLabelStrideParentPanel.setBorder(
  ...
  private void initProperty() {
    ...
    Component[] strideComponentArray = {
      this.mIndexStridePanel, this.mTickLabelStrideSyncCheckBox, this.mTickLabelStridePanel
    };
  ...
  public boolean checkSelectedItems() {
    ...
    if (!this.mIndexStridePanel.hasValidInput()) {
      ...
      if (SGDataDataTypeUtility.isSXYTypeData(this.mDataType)) {
        msg = SGDataMiscUtility.MSG_PROPER_STRIDE_LINE_AND_BAR;
      } else if (SGDataDataTypeUtility.isSXYZTypeData(this.mDataType)
          || SGDataDataTypeUtility.isVXYTypeData(this.mDataType)) {
        msg = SGDataMiscUtility.MSG_PROPER_STRIDE;
      }
  ...
  private jp.riken.brain.ni.samuraigraph.data.SGSDArrayDataColumnSelectionPanel
      mDataColumnSelectionPanel;
   ...
   *
   * @param data single dimensional data
  ...
  public boolean setData(
    ...
    if (this.setData(
            (SGSDArrayFile) data.getDataSource(),
            data.getDataType(),
            colInfoSet,
            infoMap,
            showDefault)
  ...
  public boolean setData(
    ...
    // check input values
    if (dataType == null || colInfoSet == null || infoMap == null) {
    ...
    if (SGDataDataTypeUtility.isSXYTypeData(dataType)) {
      ...
      this.mIndexStridePanel.setBorder(
  ...
  private void initStride() {
    ...
    if (stride == null) {
      Map<String, SGIntegerSeriesSet> strideMap =
          SGDataStrideUtility.calcSDArrayDefaultStride(cols, this.mInfoMap);
