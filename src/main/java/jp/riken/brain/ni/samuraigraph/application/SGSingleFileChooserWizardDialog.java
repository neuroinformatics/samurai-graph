...
/**
 * A wizard dialog to choose a file. This dialog has a button to show a file chooser and a text
 * field to display the file name.
 */
public abstract class SGSingleFileChooserWizardDialog extends SGFileChooserWizardDialog
  ...
  public SGSingleFileChooserWizardDialog(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    this.initProperty();
  }

  /** Creates new form SGPropertyFileChooserWizardDialog */
  public SGSingleFileChooserWizardDialog(java.awt.Dialog parent, boolean modal) {
    super(parent, modal);
    this.initProperty();
  }
        ...
        new Runnable() {
          public void run() {
            ...
            if (null != getFileNameTextComponent()) {
              getFileNameTextComponent()
                  .getDocument()
                  .addDocumentListener(SGSingleFileChooserWizardDialog.this);
            }
            if (null != getFileChooserButton()) {
              getFileChooserButton().addActionListener(SGSingleFileChooserWizardDialog.this);
            }
   ...
   *
   * @param f a file object whose path is to be displayed in the text field
   */
   ...
   * Sets a text string for file path to the text field.
   *
   * @param path a text string to be displayed in the text field
   */
   ...
   *
   * @param b true if the file is accepted
   */
