...
public class SGDataPropertyKeyConstants {
  ...
  /**
   * A text string of the key for the name of a variable for serial numbers. (Only for the backward
   * compatibility for the version <= 2.0.0)
   */
  ...
  /**
   * A text string of the key for the index start of a pickup. (Only for the version older than
   * 2.1.0.)
   */
  public static final String KEY_PICKUP_START = "PickupStart";

  /**
   * A text string of the key for the index end of a pickup. (Only for the version older than
   * 2.1.0.)
   */
  public static final String KEY_PICKUP_END = "PickupEnd";

  /**
   * A text string of the key for the index step of a pickup. (Only for the version older than
   * 2.1.0.)
   */
  ...
  /**
   * A key string for the array section of the serial numbers. (Only for the version older than
   * 2.1.0.)
   */
