...
public class SGPlotTypeSelectionWizardDialog extends SGWizardDialog {
  ...
  public SGPlotTypeSelectionWizardDialog(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
    this.initProperty();
  }
  ...
  private void initComponents() {
    ...
    mPlotTypeSelectionPanel.setBorder(
