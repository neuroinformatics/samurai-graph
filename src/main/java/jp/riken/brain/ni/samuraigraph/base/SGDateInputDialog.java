...
public class SGDateInputDialog extends SGAbstractDateInputDialog {
  ...
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<Integer> mDayComboBox;
  private javax.swing.JLabel mDayLabel;
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<Integer> mHourComboBox;
  ...
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<Integer> mMinuteComboBox;
  private javax.swing.JLabel mMinuteLabel;
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<Integer> mMonthComboBox;
  private javax.swing.JLabel mMonthLabel;
  private jp.riken.brain.ni.samuraigraph.base.SGButton mOKButton;
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<Integer> mSecondComboBox;
  ...
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<String> mTimeZoneComboBox;
  ...
  private void init() {
    ...
    this.mYearSpinner.initProperties(
        new SpinnerNumberModel(0.0, YEAR_MIN, YEAR_MAX, 1), null, 0, 0);
    ...
    this.mMillisecondSpinner.initProperties(new SpinnerNumberModel(0.0, 0, 999, 1), null, 0, 0);

    Set<String> minusTimeZoneSet =
        new TreeSet<String>(
  ...
  protected String createString() {
    ...
    // month
    String sMonth = String.format("%02d", this.mMonthComboBox.getSelectedItem());
    sb.append(sMonth);

    sb.append('-');

    // day
    String sDay = String.format("%02d", this.mDayComboBox.getSelectedItem());
    sb.append(sDay);

    sb.append('T');

    // hour
    String sHour = String.format("%02d", this.mHourComboBox.getSelectedItem());
    sb.append(sHour);

    sb.append(':');

    // minute
    String sMinute = String.format("%02d", this.mMinuteComboBox.getSelectedItem());
    sb.append(sMinute);

    sb.append(':');

    // second
    String sSecond = String.format("%02d", this.mSecondComboBox.getSelectedItem());
    sb.append(sSecond);
