...
public class SGAboutDialog extends SGDialog implements SGIApplicationConstants {
  ...
  private void initComponents() {
    ...
    mImagePanel.addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mouseClicked(java.awt.event.MouseEvent evt) {
            mImagePanelMouseClicked(evt);
          }
        });
    mImagePanel.addMouseMotionListener(
  ...
  private void mImagePanelMouseClicked(java.awt.event.MouseEvent evt) {
  ...
  private void mImagePanelMouseMoved(java.awt.event.MouseEvent evt) {
    final int x = evt.getX();
    final int y = evt.getY();
    if (web_rect.contains(x, y)) {
  ...
  /**
   * Link URL position in the About Dialog web_rect : http://samurai-graph.sourceforge.jp/ lab_rect
