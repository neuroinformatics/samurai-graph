...
public class SGAboutDialog extends SGDialog implements SGIApplicationConstants {
  ...
  private void mImagePanelMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_mImagePanelMouseClicked
  ...
  private void mImagePanelMouseMoved(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_mImagePanelMouseMoved
    final int x = evt.getX();
    final int y = evt.getY();
    if (web_rect.contains(x, y)) {
