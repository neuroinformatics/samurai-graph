...
public class SGVXYDataUtility {
   ...
   *
   * @param magArray an array of magnification of vectors
   * @param angleArray an array of angle of vectors
   * @return an array of x components of vectors
   */
  static double[] getXComponentArray(final double[] magArray, final double[] angleArray) {
   ...
   */
  static double[] getYComponentArray(final double[] magArray, final double[] angleArray) {
    final int len = magArray.length;
    double[] array = new double[len];
    for (int ii = 0; ii < len; ii++) {
      if (Double.isNaN(magArray[ii]) || Double.isNaN(angleArray[ii]) || magArray[ii] < 0) {
   ...
   *
   * @param xComArray an array of x component of vectors
   * @param yComArray an array of y component of vectors
   * @return an array of magnitude of vectors
   */
  static double[] getMagnitudeArray(final double[] xComArray, final double[] yComArray) {
   ...
   */
  static double[] getAngleArray(final double[] xComArray, final double[] yComArray) {
    final int len = xComArray.length;
    double[] array = new double[len];
    for (int ii = 0; ii < len; ii++) {
      final double x = xComArray[ii];
