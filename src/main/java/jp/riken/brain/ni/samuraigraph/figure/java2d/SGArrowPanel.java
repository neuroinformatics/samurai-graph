...
public class SGArrowPanel extends SGPropertyPanel implements SGIArrowConstants, ItemListener {
  ...
  private void initProperty() {
    ...
    this.mHeadSizeSpinner.initProperties(
        new SpinnerNumberModel(0.1, ARROW_HEAD_SIZE_MIN, ARROW_HEAD_SIZE_MAX, ARROW_HEAD_SIZE_STEP),
        ARROW_HEAD_SIZE_UNIT,
        ARROW_HEAD_SIZE_FRAC_DIFIT_MIN,
        ARROW_HEAD_SIZE_FRAC_DIFIT_MAX);
  ...
  public Integer getStartHeadType() {
    ...
    final Integer num = SGDrawingElementArrow.getArrowHeadTypeFromName(typeName);
    return num;
  }
  ...
  public boolean setStartHeadType(final Integer type) {
    if (type != null) {
      final String typeName = SGDrawingElementArrow.getArrowHeadTypeName(type.intValue());
  ...
  public void itemStateChanged(ItemEvent e) {
    ...
    if (source.equals(this.mStartHeadTypeComboBox) || source.equals(this.mEndHeadTypeComboBox)) {
      this.updateAngleSpinners();
    }
  }
}
