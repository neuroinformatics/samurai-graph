...
public class SGPluginInfoPanel extends SGTableSelectionPanel {
  ...
  protected void updateTextArea() {
    ...
    String name = model.getValueAt(row, model.findColumn(COLUMN_NAME_NAME)).toString();
    String version = model.getValueAt(row, model.findColumn(COLUMN_NAME_VERSION)).toString();
    String developer = model.getValueAt(row, model.findColumn(COLUMN_NAME_DEVELOPER)).toString();
