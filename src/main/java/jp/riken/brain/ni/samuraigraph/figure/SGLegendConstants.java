...
public class SGLegendConstants {
  ...
  public static final String DEFAULT_LEGEND_SCALE_REFERENCE =
      SGFigureElementAxisConstants.LEFT_BOTTOM;

  // Visible
  public static final boolean DEFAULT_LEGEND_VISIBLE = true;

  // Transparency percentage
  public static final int DEFAULT_LEGEND_BACKGROUND_TRANSPARENCY =
      SGTransparentPaint.ALL_OPAQUE_VALUE;
  ...
  // Horizontal Axis
  public static final String DEFAULT_LEGEND_HORIZONTAL_AXIS =
      SGFigureElementAxisConstants.AXIS_BOTTOM;

  // Vertical Axis
  public static final String DEFAULT_LEGEND_VERTICAL_AXIS = SGFigureElementAxisConstants.AXIS_LEFT;
