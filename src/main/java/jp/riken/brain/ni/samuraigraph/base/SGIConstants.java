...
public interface SGIConstants {
  ...
  public static final String MENUCMD_FIT_ALL_AXES_TO_DATA_FOR_ALL_ANIMATION_FRAMES =
      "All Axes (All Animation Frames)";
  ...
  /**
   * The menu command to merge multiple data objects which was split into the original data object.
   */
