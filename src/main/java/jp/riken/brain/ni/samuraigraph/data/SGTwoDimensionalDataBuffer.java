...
public abstract class SGTwoDimensionalDataBuffer extends SGDataBuffer {
  ...
  protected void checkTwoDimensionalArray(
      double[] xValues, double[] yValues, double[][] twoDimValues, String name) {
  ...
  protected List<SGXYSimpleDoubleValueIndexBlock> copyBlocks(
      List<SGXYSimpleDoubleValueIndexBlock> list) {
  ...
  protected SGXYSimpleDoubleValueIndexBlock createBlock(
      final double[] xValues, final double[] yValues, final double[][] twoDimValues) {
    ...
    SGXYSimpleDoubleValueIndexBlock block =
        new SGXYSimpleDoubleValueIndexBlock(flatArray, xSeries, ySeries);
    return block;
  }
