...
public class SGGradationPaintDialog extends JDialog
  ...
  public SGGradationPaintDialog(final JDialog parent, final String title, final boolean modal) {
  ...
  public void stateChanged(final ChangeEvent e) {
    ...
    if (this.mCurrentColorSetButton != null && (source instanceof ColorSelectionModel)) {
  ...
  public void actionPerformed(ActionEvent e) {
    Object source = e.getSource();
    if (source == this.mColorSelectionButton1 || source == this.mColorSelectionButton2) {
