...
public abstract class SGDialog extends JDialog
  ...
  /**
   * Set the location of this dialog as the center of this dialog is equal to the center of the
   * given window.
   *
  ...
  /**
   * Parse the text string in the given text component, and returns a Number object if it is parsed
   * as number.
   *
   ...
   *
   * @param num the closed option to set
   */
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (this.getColorSelectionButtonsList().contains(source)) {
      ...
      SGUtility.showColorSelectionDialog(this.mColorDialog, btn, btn.getColor(), x, y);
    }
  }
   ...
   * @return true if the component is a part of the color chooser dialog
   */
