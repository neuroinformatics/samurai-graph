...
public class SGAxisBreakConstants {
  ...
  public static final int AXIS_BREAK_DISTORTION_MINIMAL_ORDER =
  ...
  // Horizontal Axis
  public static final String DEFAULT_AXIS_BREAK_HORIZONTAL_AXIS =
      SGFigureElementAxisConstants.AXIS_BOTTOM;

  // Vertical Axis
  public static final String DEFAULT_AXIS_BREAK_VERTICAL_AXIS =
