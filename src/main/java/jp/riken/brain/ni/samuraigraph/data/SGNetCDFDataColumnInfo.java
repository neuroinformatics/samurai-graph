...
public class SGNetCDFDataColumnInfo extends SGDataColumnInfo {
   ...
   */
  public SGNetCDFDataColumnInfo(
      final SGNetCDFVariable var, final String title, final String valueType, final int origin) {
   ...
   * Sets the origin.
   *
   * @param origin the value to set to the origin
   */
