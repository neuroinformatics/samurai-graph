...
public class SGFigureElementSignificantDifference extends SGFigureElement2D
  ...
  public boolean readProperty(final Element element, final String versionNumber) {
    ...
    for (int ii = 0; ii < nList.getLength(); ii++) {
      ...
      if (node instanceof Element) {
        ...
        String modStr =
            SGUtilityForFigureElementJava2D.modifyStringForCompatibility(str, versionNumber);
        sd.setText(modStr);
  ...
  public boolean getMarginAroundGraphRect(SGTuple2f topAndBottom, SGTuple2f leftAndRight) {
    ...
    final float bottom =
        -(this.mGraphRectY + this.mGraphRectHeight)
            + (float) (uniRect.getY() + uniRect.getHeight());
    final float left = this.mGraphRectX - (float) uniRect.getX();
    final float right =
        -(this.mGraphRectX + this.mGraphRectWidth) + (float) (uniRect.getX() + uniRect.getWidth());
  ...
  /** */
  private boolean clickDrawingElements(final SigDiffSymbol el, final MouseEvent e) {
    final int x = e.getX();
    final int y = e.getY();
    final int mod = e.getModifiersEx();
  ...
  private class SigDiffSymbol extends SGDrawingElementSignificantDifference2D
    ...
    public boolean readProperty(final Element el) {
      ...
      if (str.length() != 0) {
        SGAxis xAxis = SGFigureElementSignificantDifference.this.mAxisElement.getAxis(str);
        if (xAxis == null) {
          return false;
        }
        this.mXAxis = xAxis;
      ...
      if (str.length() != 0) {
        SGAxis yAxis = SGFigureElementSignificantDifference.this.mAxisElement.getAxis(str);
        if (yAxis == null) {
          return false;
        }
        this.mYAxis = yAxis;
    ...
    public SGTuple2f getLocation() {
      ...
      final float x =
          this.getMagnification() * baseX + SGFigureElementSignificantDifference.this.mGraphRectX;
      final float y =
          this.getMagnification() * baseY + SGFigureElementSignificantDifference.this.mGraphRectY;
    ...
    public boolean setLocation(final float x, final float y) {
      final float mag = this.getMagnification();
      final float nx = (x - SGFigureElementSignificantDifference.this.mGraphRectX) / mag;
      final float ny = (y - SGFigureElementSignificantDifference.this.mGraphRectY) / mag;
    ...
    public boolean hasValidHorizontalYValue(final int location, final Number value) {
      final SGAxis axis =
          (location == -1)
              ? this.mYAxis
              : SGFigureElementSignificantDifference.this.mAxisElement.getAxisInPlane(location);
    ...
    private boolean pressDrawingElements(final MouseEvent e) {
      ...
      if (this.contains(x, y) || this.getStringElement().contains(x, y)) {
        ...
        this.mTempSymbol.setSize(
            this.getWidth(), this.getVerticalHeight1(), this.getVerticalHeight2());
    ...
    private ArrayList<Point2D> getAnchorPointList() {
      ...
      Rectangle2D rect =
          ((SGDrawingElementString2DExtended) this.getStringElement()).getElementBounds();
    ...
    private boolean dragOtherPoint(final MouseEvent e) {
      ...
      if (SGFigureElementSignificantDifference.this.mPressedPoint != null) {
        ...
        this.translateSub(dx, dy);
        SGFigureElementSignificantDifference.this.mPressedPoint = e.getPoint();
      }
    ...
    private boolean drag(final MouseEvent e) {
      ...
      SGFigureElementSignificantDifference.this.mPressedPoint.setLocation(
          SGFigureElementSignificantDifference.this.mPressedPoint.getX() + diffX,
          SGFigureElementSignificantDifference.this.mPressedPoint.getY() + diffY);
    ...
    private void addProperties(
        ...
        String rightXKey,
        String rightYKey,
        String horizontalYKey,
        String axisXKey,
        String axisYKey,
        String anchorKey) {
      SGPropertyUtility.addProperty(map, leftXKey, this.getLeftXValue());
      SGPropertyUtility.addProperty(map, leftYKey, this.getLeftYValue());
      SGPropertyUtility.addProperty(map, rightXKey, this.getRightXValue());
      SGPropertyUtility.addProperty(map, rightYKey, this.getRightYValue());
      SGPropertyUtility.addProperty(map, horizontalYKey, this.getHorizontalYValue());
      SGPropertyUtility.addProperty(map, axisXKey, mAxisElement.getLocationName(this.mXAxis));
      SGPropertyUtility.addProperty(map, axisYKey, mAxisElement.getLocationName(this.mYAxis));
  ...
  public SGPropertyResults setChildProperties(final int id, SGPropertyMap map) {
    ...
    if (child == null) {
      ...
      if (this.addSignificantDifferenceSymbol(
              id,
              leftX.doubleValue(),
              leftY.doubleValue(),
              rightX.doubleValue(),
              rightY.doubleValue(),
              horizontalY.doubleValue(),
              sAxisX,
              sAxisY)
          == false) {
        return null;
