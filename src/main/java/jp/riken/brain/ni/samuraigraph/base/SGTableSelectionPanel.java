...
/**
 * This panel has a table and a text area. Information of selected row is displayed in the text
 * area.
 */
public abstract class SGTableSelectionPanel extends JPanel implements MouseListener {
  ...
  protected abstract static class SelectionTableModel extends DefaultTableModel {
