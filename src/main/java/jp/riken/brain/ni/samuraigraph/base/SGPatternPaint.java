...
public class SGPatternPaint extends SGTransparentPaint {
  ...
  public Paint getOpaquePaint(final Rectangle2D rect, final float magnification) {
    switch (this.mTypeIndex) {
      case INDEX_0_DEGREE:
        return getPatternPaint_Size3x3(this.mColor, Color.WHITE, 0, magnification);
      case INDEX_45_DEGREE:
        return getPatternPaint_Size4x4(this.mColor, Color.WHITE, 1, magnification);
      case INDEX_90_DEGREE:
        return getPatternPaint_Size3x3(this.mColor, Color.WHITE, 3, magnification);
      case INDEX_135_DEGREE:
        return getPatternPaint_Size4x4(this.mColor, Color.WHITE, 2, magnification);
      case INDEX_STRIPES_0_DEGREE:
        return getPatternPaint_Stripe_Size4x4(this.mColor, Color.WHITE, 0, this.mMagnification);
      case INDEX_STRIPES_45_DEGREE:
        return getPatternPaint_Stripe_Size4x4(this.mColor, Color.WHITE, 2, this.mMagnification);
      case INDEX_3_STRIPES_90_DEGREE:
        return getPatternPaint_3_stripes_Size5x5(this.mColor, Color.WHITE, this.mMagnification);
      case INDEX_45_DEGREE_WIDE:
        return getPatternPaint_Size10x10(this.mColor, Color.WHITE, 1, this.mMagnification);
      default:
        return null;
    }
  }
   ...
   *
   * @param name the name of pattern type
  ...
  public SGPropertyMap getPropertyFileMap() {
    ...
    SGPropertyUtility.addProperty(
        map, KEY_PATTERN_TYPE, SGPatternPaint.getTypeName(this.getTypeIndex()));
    return map;
  }
}
