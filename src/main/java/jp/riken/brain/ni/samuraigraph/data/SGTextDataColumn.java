...
public class SGTextDataColumn extends SGDataColumn {
   ...
   *
   * @param title a text string for the title
   * @param array an array of text strings
   */
   ...
   *
   * @param title a text string for the title
   * @param stringArray an array of text strings
   * @param mod the modifier
   */
  public SGTextDataColumn(
      final String title, final String[] stringArray, final SGIStringModifier mod) {
  ...
  public Object getValue(final int rowIndex) {
    if (rowIndex > this.mArray.length) {
      throw new IllegalArgumentException(
          "Index out of bounds: " + rowIndex + " > " + this.mArray.length);
    }
   ...
   *
   * @param stride the stride of an array
   * @return an array of text strings
   */
