...
public class SGSDArrayDataDuplicationDialog extends SGDataDuplicationDialog {
   ...
   *
   * @param initName initial value for the data name
   * @param data the single-dimensional array data
   * @param colInfoSet column information
  ...
  public boolean setData(
    ...
    // set to the panel
    if (this.mDataSetupPanel.setData(data, colInfoSet, infoMap, false) == false) {
      return false;
    }
    return true;
  }
