...
public class SGSingleDataFileChooserWizardDialog extends SGSingleFileChooserWizardDialog
  ...
  private void initComponents() {
    ...
    mNetCDFDataFileChooserPanel =
        new jp.riken.brain.ni.samuraigraph.application.SGNetCDFDataFileChooserPanel();
  ...
  private jp.riken.brain.ni.samuraigraph.application.SGNetCDFDataFileChooserPanel
      mNetCDFDataFileChooserPanel;
    ...
    addWindowListener(
        new WindowAdapter() {
          ...
          public void windowOpened(WindowEvent e) {
            SGSingleDataFileChooserWizardDialog.this.mNetCDFDataFileChooserPanel
                .focusedToLocalFileTextField();
          }
        });
  ...
  /**
   * @return true if fileName is a name of local file and it exists. Or true if netCDF URL is
   *     selected and the url is set.
   */
  @Override
