...
public abstract class SGMDArrayVariable extends SGVariable implements Cloneable {
   ...
   *
   * @param map a map of dimension indices
   */
   ...
   * Sets the origins.
   *
   * @param origins an array of origins
   */
  public void setOrigins(final int[] origins) {
    ...
    if (origins.length != dims.length) {
      throw new IllegalArgumentException(
          "Length of given origin array is invalid: " + origins.length);
    }
   ...
   *
   * @param stride the stride for string array
   * @return the string array of the generic dimension
   */
  ...
  /**
   * Returns the array of double values for given dimension index with given stride and the current
   * origins.
   *
   * @param dimensionIndex dimension index
   * @param stride stride of the array
  ...
  /**
   * Returns the array of double values for given dimension indices of x and y values with the
   * current origins.
   *
  ...
  /**
   * Returns the array of double values for given dimension indices with given stride and the
   * current origins.
   *
   * @param xIndex dimension index for x-values
   * @param yIndex dimension index for y-values
  ...
  public double[] getDoubleArray(
      final int xIndex, final int yIndex, final SGIntegerSeries xSeries, SGIntegerSeries ySeries) {
   ...
   * @return an array of text strings
   */
  public abstract String[] getStringArray(final int dimensionIndex, SGIntegerSeriesSet stride);
