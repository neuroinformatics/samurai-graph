...
class SGMainFunctionsSplitMerge implements SGIApplicationTextConstants {
   ...
   * @param dataList
   * @param progress
   * @return list of data which is added by splitting multiple data. or null if failed to split.
   */
  private static List<SGData> splitDataSub(
    ...
    SGIFigureElementString fes =
        (SGIFigureElementString) figure.getIFigureElement(SGIFigureElementString.class);
          ...
          for (int jj = 0; jj < elArray.length; jj++) {
            ...
            if (sp instanceof MultipleSXYElementGroupSetPropertiesInFigureElement) {
              MultipleSXYElementGroupSetPropertiesInFigureElement mgp =
                  (MultipleSXYElementGroupSetPropertiesInFigureElement) sp;
  ...
  private static List<SGData> mergeDataSub(
      ...
      final List<SGData> mergedDataList,
    ...
    // remove single data
    Map<SGIDataSource, List<SGData>> dataSrcMapTmp =
        new HashMap<SGIDataSource, List<SGData>>(dataSrcMap);
          ...
          if (sp instanceof MultipleSXYElementGroupSetPropertiesInFigureElement) {
            ...
            for (int ii = 0; ii < store.size(); ii++) {
              ...
              MultipleSXYElementGroupSetPropertiesInFigureElement p =
                  (MultipleSXYElementGroupSetPropertiesInFigureElement)
                      gElement.getDataProperties(data);
