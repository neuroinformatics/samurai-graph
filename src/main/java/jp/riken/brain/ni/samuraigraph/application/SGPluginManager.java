...
public class SGPluginManager implements SGIDisposable {
  ...
  private Map<FileFilter, SGIPluginOutputDataToFile> getPluginFilterMap() {
    ...
    Map<FileFilter, SGIPluginOutputDataToFile> pluginMap =
        new HashMap<FileFilter, SGIPluginOutputDataToFile>();
  ...
  private JFileChooser getFileChooser(final Set<FileFilter> filterSet) {
    ...
    String path =
        SGApplicationUtility.getPathName(this.getCurrentFilePath(), this.getCurrentFileName());
  ...
  private String getCurrentFileName() {
    if (this.mCurrentFileName == null || this.mCurrentFileName.equals("")) {
      this.mCurrentFileName =
          SGApplicationUtility.appendExtension(DEFAULT_OUTPUT_FILE_NAME, DEFAULT_OUTPUT_FILE_EXT);
    }
