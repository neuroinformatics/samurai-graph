...
public class SGNetCDFDataColumnSelectionPanel extends SGDataColumnSelectionPanel {
  ...
  public static final String[] COLUMN_NAME_ARRAY = {
    ...
    COLUMN_NAME_DIMENSION,
    COLUMN_NAME_COLUMN_TYPE
  };

  /** A constant array of column width. */
  private static final int[] PREFERRED_COLUMN_WIDTH_ARRAY = {10, 80, 60, 80, 120};
  ...
  protected class NetCDFDataColumnTableModel extends DataColumnTableModel {
    ...
    protected void addData(int index, SGDataColumnInfo info) {
      ...
      Object[] array = {
        Integer.toString(index + 1), info.getTitle(), info.getValueType(), sb.toString(), cType
      };
