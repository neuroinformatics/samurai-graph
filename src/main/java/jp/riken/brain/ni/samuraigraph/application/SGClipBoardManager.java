...
class SGClipBoardManager
  ...
  private List<Map<Class<? extends SGIFigureElement>, SGProperties>> mCopiedDataPropertiesBuffer =
   ...
   */
  boolean cutAndCopy(final SGDrawingWindow wnd, final boolean isCopy) {
    // clear all lists
    this.clearAllLists();
    ...
    List<Map<Class<? extends SGIFigureElement>, SGProperties>> pList =
        wnd.getCopiedDataPropertiesMapList();
  ...
  // Copies the figure.
  private boolean copyFigures(
      SGDrawingWindow wnd, WindowInfo info, final SGExportParameter operation) {
