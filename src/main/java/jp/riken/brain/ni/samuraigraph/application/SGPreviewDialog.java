...
public final class SGPreviewDialog extends SGDialog implements AdjustmentListener {
   ...
   */
  public SGPreviewDialog(final Dialog owner, final String title, final boolean modal) {
   ...
   * @param modal true if modal
   */
  public SGPreviewDialog(final Frame owner, final String title, final boolean modal) {
    super(owner, title, modal);
    this.initComponents();
  }
  ...
  public void paint(Graphics g) {
    ...
    if (sPane != null) {
      Component corner = sPane.getCorner(ScrollPaneConstants.LOWER_RIGHT_CORNER);
      if (corner != null) {
        corner.repaint();
      }
  ...
  public boolean setTargetObject(
    ...
    this.mScrollPane.setCorner(ScrollPaneConstants.LOWER_RIGHT_CORNER, corner);
   ...
   *
   * @param text a text string to be set
   */
  ...
  private static class BackgroundPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
      ...
      if (this.mComponent != null) {
        ...
        Line2D line0 =
            new Line2D.Float(x, rect.y + 1.5f * lineWidth, x, rect.y + rect.height + lineWidth / 2);
        final int y = rect.y + rect.height + lineWidth / 2;
        Line2D line1 =
            new Line2D.Float(rect.x + 1.5f * lineWidth, y, rect.x + rect.width + lineWidth / 2, y);
        g2d.draw(line0);
        g2d.draw(line1);
