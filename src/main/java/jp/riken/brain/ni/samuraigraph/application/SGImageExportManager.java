...
public class SGImageExportManager implements SGIImageExportManager, SGIConstants {
  ...
  /**
   * The command key for Vector graphics. FontConstants.TEXT_AS_SHAPES = "TEXT_AS_SHAPES" does not
   * match other key name style.
   */
  ...
  public SGImageExportManager() {
    ...
    try {
      java.lang.reflect.Field typeField =
          org.freehep.graphicsbase.util.export.ExportDialog.class.getDeclaredField("type");
   ...
   *
   * @param target target object to export
   * @param owner the owner of the preview dialog
  ...
  private static String[] getMarginList() {
    return new String[] {
      "No Margin", PageConstants.SMALL, PageConstants.MEDIUM, PageConstants.LARGE
    };
  }
   ...
   * Exports the target object as an image file.
   *
   * @param target the target object to export
  ...
  public SGPropertyResults export(
    ...
    try {
      if (ImageConstants.EMF.equalsIgnoreCase(type)) {
        ...
        // "Transparent"
        this.setBoolean(prop, PageConstants.TRANSPARENT, p, EMFGraphics2D.TRANSPARENT, result);

        // "Background"
        final boolean bgFlag =
            this.setBoolean(prop, PageConstants.BACKGROUND, p, EMFGraphics2D.BACKGROUND, result);
        ...
        this.setBackgroundColor(
            ...
            p,
            EMFGraphics2D.BACKGROUND_COLOR,
            target,
            bgFlag,
            result);

        // "TEXT_AS_SHAPES"
        this.setBoolean(prop, TEXT_AS_SHAPES, p, EMFGraphics2D.TEXT_AS_SHAPES, result);
        ...
        // "Background"
        final boolean bgFlag =
            this.setBoolean(prop, PageConstants.BACKGROUND, p, PSGraphics2D.BACKGROUND, result);
        ...
        // "PageSize"
        this.setString(
            prop, PageConstants.PAGE_SIZE, p, PSGraphics2D.PAGE_SIZE, getSizeList(), result);

        // "PageMargins"
        this.setMargin(prop, PageConstants.PAGE_MARGINS, p, PSGraphics2D.PAGE_MARGINS, result);
        ...
        this.setString(
            ...
            p,
            PSGraphics2D.ORIENTATION,
            getOrientationList(),
            result);

        // "FitToPage"
        this.setBoolean(prop, PageConstants.FIT_TO_PAGE, p, PSGraphics2D.FIT_TO_PAGE, result);

        // "EmbedFonts"
        this.setBoolean(prop, FontConstants.EMBED_FONTS, p, PSGraphics2D.EMBED_FONTS, result);
        ...
        this.setString(
            ...
            p,
            PSGraphics2D.EMBED_FONTS_AS,
            getEmbedFontsAsList(),
            result);

        // "TEXT_AS_SHAPES"
        this.setBoolean(prop, TEXT_AS_SHAPES, p, PSGraphics2D.TEXT_AS_SHAPES, result);

        // "For"
        this.setText(prop, InfoConstants.FOR, p, PSGraphics2D.FOR, result);

        // "Title"
        this.setText(prop, InfoConstants.TITLE, p, PSGraphics2D.TITLE, result);
        ...
        if ("EPS".equalsIgnoreCase(type)) {
          ...
          // "PreviewBits"
          this.setInteger(
              prop, "PreviewBits", p, PSGraphics2D.PREVIEW_BITS, new int[] {1, 2, 4, 8}, result);
        }
        ...
        // "Transparent"
        this.setBoolean(prop, PageConstants.TRANSPARENT, p, PDFGraphics2D.TRANSPARENT, result);

        // "Background"
        final boolean bgFlag =
            this.setBoolean(prop, PageConstants.BACKGROUND, p, PDFGraphics2D.BACKGROUND, result);
        ...
        this.setBackgroundColor(
            ...
            PageConstants.BACKGROUND_COLOR,
            p,
            PDFGraphics2D.BACKGROUND_COLOR,
            target,
            bgFlag,
            result);
        ...
        // "PageSize"
        this.setString(
            prop, PageConstants.PAGE_SIZE, p, PDFGraphics2D.PAGE_SIZE, getSizeList(), result);

        // "PageMargins"
        this.setMargin(prop, PageConstants.PAGE_MARGINS, p, PDFGraphics2D.PAGE_MARGINS, result);
        ...
        this.setString(
            ...
            PageConstants.ORIENTATION,
            p,
            PDFGraphics2D.ORIENTATION,
            getOrientationList(),
            result);

        // "FitToPage"
        this.setBoolean(prop, PageConstants.FIT_TO_PAGE, p, PDFGraphics2D.FIT_TO_PAGE, result);

        // "EmbedFonts"
        this.setBoolean(prop, FontConstants.EMBED_FONTS, p, PDFGraphics2D.EMBED_FONTS, result);
        ...
        this.setString(
            ...
            FontConstants.EMBED_FONTS_AS,
            p,
            PDFGraphics2D.EMBED_FONTS_AS,
            getEmbedFontsAsList(),
            result);

        // "TEXT_AS_SHAPES"
        this.setBoolean(prop, TEXT_AS_SHAPES, p, PDFGraphics2D.TEXT_AS_SHAPES, result);
        ...
        this.setString(
            ...
            ImageConstants.WRITE_IMAGES_AS,
            p,
            PDFGraphics2D.WRITE_IMAGES_AS,
            new String[] {ImageConstants.SMALLEST, ImageConstants.ZLIB, ImageConstants.JPG},
            result);

        // "Author"
        this.setText(prop, InfoConstants.AUTHOR, p, PDFGraphics2D.AUTHOR, result);

        // "Title"
        this.setText(prop, InfoConstants.TITLE, p, PDFGraphics2D.TITLE, result);

        // "Subject"
        this.setText(prop, InfoConstants.SUBJECT, p, PDFGraphics2D.SUBJECT, result);

        // "Keywords"
        this.setText(prop, InfoConstants.KEYWORDS, p, PDFGraphics2D.KEYWORDS, result);
        ...
        // "Transparent"
        this.setBoolean(prop, PageConstants.TRANSPARENT, p, SVGGraphics2D.TRANSPARENT, result);

        // "Background"
        final boolean bgFlag =
            this.setBoolean(prop, PageConstants.BACKGROUND, p, SVGGraphics2D.BACKGROUND, result);
        ...
        this.setBackgroundColor(
            ...
            PageConstants.BACKGROUND_COLOR,
            p,
            SVGGraphics2D.BACKGROUND_COLOR,
            target,
            bgFlag,
            result);
        ...
        // "ImageSize"
        this.setDimension(prop, ImageConstants.IMAGE_SIZE, p, SVGGraphics2D.IMAGE_SIZE, result);

        // "ExportImages"
        this.setBoolean(prop, "ExportImages", p, SVGGraphics2D.EXPORT_IMAGES, result);

        // "ExportSuffix"
        this.setText(prop, "ExportSuffix", p, SVGGraphics2D.EXPORT_SUFFIX, result);
        ...
        this.setString(
            ...
            ImageConstants.WRITE_IMAGES_AS,
            p,
            SVGGraphics2D.WRITE_IMAGES_AS,
            new String[] {ImageConstants.SMALLEST, ImageConstants.PNG, ImageConstants.JPG},
            result);

        // "TEXT_AS_SHAPES"
        this.setBoolean(prop, TEXT_AS_SHAPES, p, SVGGraphics2D.TEXT_AS_SHAPES, result);
        ...
        if (strResolution != null) {
          ...
          if (resolution != null) {
            if (resolution > 0.0) {
              ...
              Dimension scaledD =
                  new Dimension(
                      (int) Math.round(d.width * scale), (int) Math.round(d.height * scale));
          ...
          final int status =
              valid ? SGPropertyResults.SUCCEEDED : SGPropertyResults.INVALID_INPUT_VALUE;
        ...
        final boolean bgFlag =
            this.setBoolean(
                prop, PageConstants.BACKGROUND, p, formatKey + ImageGraphics2D.BACKGROUND, result);
        ...
        this.setBackgroundColor(
            ...
            PageConstants.BACKGROUND_COLOR,
            p,
            formatKey + ImageGraphics2D.BACKGROUND_COLOR,
            target,
            bgFlag,
            result);

        // "Antialias"
        this.setBoolean(prop, "Antialias", p, formatKey + ImageGraphics2D.ANTIALIAS, result);

        // "AntialiasText"
        this.setBoolean(
            prop, "AntialiasText", p, formatKey + ImageGraphics2D.ANTIALIAS_TEXT, result);
        ...
        if (ImageConstants.JPG.equalsIgnoreCase(type)
            ...
            || ImageConstants.PNG.equalsIgnoreCase(type)) {
          // "Progressive"
          this.setBoolean(prop, "Progressive", p, ImageGraphics2D.PROGRESSIVE, result);
        }
        ...
        this.setFloat(
            ...
            "QualityValue",
            p,
            ImageGraphics2D.COMPRESS_QUALITY,
            new SGTuple2f(0.0f, 1.0f),
            result);
   ...
   *
   * @param prop the map input properties
   * @param propKey the key for the map of input properties
      ...
      if (marginTextArray != null) {
        ...
        for (int ii = 0; ii < margins.length; ii++) {
          if (SGUtilityText.isEqualString(margins[ii], value)) {
            Insets in =
                "No Margin".equals(margins[ii])
                    ? new Insets(0, 0, 0, 0)
                    : PageConstants.getMargins(margins[ii]);
            p.setProperty(key, in);
            result.putResult(propKey, SGPropertyResults.SUCCEEDED);
            return true;
          }
  ...
  public boolean print(
      final Component target, final Frame owner, final int w, final int h, final boolean silent) {
