...
/**
 * The SGIUndoable interface provides definitions for undoable objects. Collaborating with the
 * SGUndoManager object, undoable objects can record its change tracking and recover the properties.
 */
