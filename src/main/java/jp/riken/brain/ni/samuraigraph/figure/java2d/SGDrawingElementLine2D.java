...
public abstract class SGDrawingElementLine2D extends SGDrawingElementLine
   ...
   */
  public SGDrawingElementLine2D(final float x1, final float y1, final float x2, final float y2) {
    super(x1, y1, x2, y2);
  }
