...
/**
 * The class of a menu item with check box which has the "indeterminate" property. If this object is
 * in the "indeterminate" state, it is neither selected nor unselected. Note that the method
 * isSelected, which is inherited from the super class JCheckBoxMenuItem, returns false in the
 * indeterminate state.
 */
public class SGCheckBoxMenuItem extends JCheckBoxMenuItem implements ActionListener {
   ...
   *
   * @param b if b is equal to Boolean.TRUE, this check box is set to be selected. and if b equals
   *     to Boolean.FALSE, to be not selected. If b is equal to null, this check box is set to be in
   *     indeterminate state.
   */
   ...
   *
   * @return if this check box is not in the indeterminate state, it equals to Boolean.TRUE or
   *     Boolean.FALSE. Otherwise, it equals to null.
   */
