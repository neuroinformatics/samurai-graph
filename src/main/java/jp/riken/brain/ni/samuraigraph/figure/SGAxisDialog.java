...
public class SGAxisDialog extends SGPropertyDialog implements SGIAxisConstants {
  ...
  private boolean initProperty() {
    ...
    this.mTitleShiftFromCenterSpinner.initProperties(
        new SpinnerNumberModel(0.0, TITLE_SHIFT_MIN, TITLE_SHIFT_MAX, TITLE_SHIFT_STEP),
        TITLE_SHIFT_UNIT,
        TITLE_SHIFT_FRAC_DIGIT_MIN,
        TITLE_SHIFT_FRAC_DIGIT_MAX);
    ...
    this.mExponentSpinner.initProperties(
        new SpinnerNumberModel(0.0, AXIS_EXPONENT_MIN, AXIS_EXPONENT_MAX, AXIS_EXPONENT_STEP),
        null,
        0,
        0);

    // exponent location
    this.mNumberExponentLocationXSpinner.initProperties(
        new SpinnerNumberModel(
            0.0, EXPONENT_LOCATION_MIN, EXPONENT_LOCATION_MAX, EXPONENT_LOCATION_STEP),
        EXPONENT_LOCATION_UNIT,
        EXPONENT_LOCATION_FRAC_DIGIT_MIN,
        EXPONENT_LOCATION_FRAC_DIGIT_MAX);
    this.mNumberExponentLocationYSpinner.initProperties(
        new SpinnerNumberModel(
            0.0, EXPONENT_LOCATION_MIN, EXPONENT_LOCATION_MAX, EXPONENT_LOCATION_STEP),
        EXPONENT_LOCATION_UNIT,
        EXPONENT_LOCATION_FRAC_DIGIT_MIN,
    ...
    this.mTickMarkLengthSpinner.initProperties(
        new SpinnerNumberModel(
            0.10, TICK_MARK_LENGTH_MIN, TICK_MARK_LENGTH_MAX, TICK_MARK_LENGTH_STEP),
        TICK_MARK_LENGTH_UNIT,
        TICK_MARK_LENGTH_FRAC_DIFIT_MIN,
        TICK_MARK_LENGTH_FRAC_DIFIT_MAX);

    // minor tick mark number
    this.mMinorTickMarkNumberSpinner.initProperties(
        new SpinnerNumberModel(
            0.0,
            MINOR_TICK_MARK_NUMBER_MIN,
            MINOR_TICK_MARK_NUMBER_MAX,
            MINOR_TICK_MARK_NUMBER_STEP),
        null,
        0,
        0);

    // minor tick mark length
    this.mMinorTickMarkLengthSpinner.initProperties(
        new SpinnerNumberModel(
            0.10,
            MINOR_TICK_MARK_LENGTH_MIN,
            MINOR_TICK_MARK_LENGTH_MAX,
            MINOR_TICK_MARK_LENGTH_STEP),
        TICK_MARK_LENGTH_UNIT,
        MINOR_TICK_MARK_LENGTH_FRAC_DIGIT_MIN,
        MINOR_TICK_MARK_LENGTH_FRAC_DIGIT_MAX);

    // shift
    this.mAxisShiftSpinner.initProperties(
        new SpinnerNumberModel(0.0, AXIS_SHIFT_MIN, AXIS_SHIFT_MAX, AXIS_SHIFT_STEP),
        AXIS_SHIFT_UNIT,
        AXIS_SHIFT_FRAC_DIGIT_MIN,
        AXIS_SHIFT_FRAC_DIGIT_MAX);
    ...
    this.mSpaceAxisLineAndNumbersSpinner.setDescription(
        "Axis Line-> " + this.mSpaceAxisLineAndNumbersLabel.getText());
    this.mTitleTextField.setDescription("Title-> " + this.mTextLabel.getText());
    this.mSpaceTitleAndNumbersSpinner.setDescription(
        "Title-> " + this.mSpaceTitleAndNumbersLabel.getText());
    this.mTitleShiftFromCenterSpinner.setDescription(
        "Title-> " + this.mTitleShiftFromCenterLabel.getText());
    ...
    this.mNumberExponentLocationXSpinner.setDescription(
        "Number-> Exponent " + this.mNumberExponentLocationXLabel.getText());
    this.mNumberExponentLocationYSpinner.setDescription(
        "Number-> Exponent " + this.mNumberExponentLocationYLabel.getText());
    this.mNumberFontSizeSpinner.setDescription("Number-> " + this.mNumberFontSizeLabel.getText());
    this.mNumberDateFormatComboBox.setDescription(
        "Number-> " + this.mNumberDateFormatLabel.getText());
    this.mTickMarkWidthSpinner.setDescription("Tick Mark-> " + this.mTickMarkWidthLabel.getText());
    this.mTickMarkLengthSpinner.setDescription(
        "Tick Mark-> " + this.mTickMarkLengthLabel.getText());
    this.mMinorTickMarkNumberSpinner.setDescription(
        "Tick Mark-> " + this.mMinorTickMarkNumberLabel.getText());
    this.mMinorTickMarkLengthSpinner.setDescription(
        "Tick Mark-> " + this.mMinorTickMarkLengthLabel.getText());
  ...
  public List<JTextField> getTextFieldComponentsList() {
    List<JTextField> list =
        new ArrayList<JTextField>(this.getFormattedTextFieldsListFromSpinners());
  ...
  public boolean setDialogProperty() {
    ...
    for (int ii = 0; ii < num; ii++) {
      ...
      spaceLineAndNumbersArray[ii] =
          l.getSpaceAxisLineAndNumbers(SGILineAndStringConstants.SPACE_UNIT);

      // title
      titleVisibleArray[ii] = l.isTitleVisible();
      titleTextArray[ii] = l.getTitleString();
      spaceTitleAndNumbersArray[ii] =
          l.getSpaceTitleAndNumbers(SGILineAndStringConstants.SPACE_UNIT);
  ...
  public boolean setPropertiesToObserver(SGIPropertyDialogObserver l) {
    ...
    try {
      ...
      this.addInputErrorDescription(this.mMinValueTextField.getDescription());
    ...
    try {
      ...
      this.addInputErrorDescription(this.mMaxValueTextField.getDescription());
      validAxisValue = false;
    }
    ...
    try {
      ...
      if (autoCalc != null && !autoCalc) {
        this.addInputErrorDescription(this.mBaselineTextField.getDescription());
        validAxisValue = false;
      }
    }
    ...
    try {
      ...
      if (autoCalc != null && !autoCalc) {
        this.addInputErrorDescription(this.mStepTextField.getDescription());
        validAxisValue = false;
      }
    }
    if (!validAxisValue) {
    ...
    if (spaceLineAndNumbers != null) {
      axis.setSpaceAxisLineAndNumbers(
          spaceLineAndNumbers.floatValue(), SGILineAndStringConstants.SPACE_UNIT);
    }
    ...
    if (spaceTitleAndNumbers != null) {
      axis.setSpaceTitleAndNumbers(
          spaceTitleAndNumbers.floatValue(), SGILineAndStringConstants.SPACE_UNIT);
    }
   ...
   *
   * @param name a text string to set to the name of check box
   */
