...
public abstract class SGTwoDimensionalMDArrayData extends SGMDArrayData
  ...
  public boolean setData(SGData data) {
    if (!(data instanceof SGTwoDimensionalMDArrayData)) {
      throw new IllegalArgumentException(
          "Given data is not the instance of SGTwoDimensionalMDArrayData class.");
    }
  ...
  public abstract static class TwoDimensionalMDArrayDataProperties extends MDArrayDataProperties {
    ...
    public Object copy() {
      ...
      p.scatterStride =
          (this.scatterStride != null) ? (SGIntegerSeriesSet) this.scatterStride.clone() : null;
      return p;
    }
  }
  ...
  protected int getAllPointsNumberSub(
      final SGMDArrayVariable var, String name, SGMDArrayVariable componentVar) {
    if (var != null) {
  ...
  protected abstract double[] getValueArraySub(
      final boolean all, final SGMDArrayVariable var, final SGIntegerSeriesSet stride, String name);
  ...
  protected double[][] getTwoDimensionalValueArray(
      final double[] values, SGMDArrayVariable var, EXPORT_TYPE type, final boolean all) {
  ...
  protected double[] getValueArray(
      SGMDArrayVariable var, final boolean all, String xKey, String yKey) {
  ...
  protected String getComponentToolTipSpatiallyVaried(
  ...
  private Map<Integer, Double> getEditedValueMap(
      SGMDArrayVariable var,
      String xColumnType,
      String yColumnType,
  ...
  protected MDDoubleArray setEditedValues(
    ...
    Map<Integer, Double> valueMap =
        this.getEditedValueMap(var, xColumnType, yColumnType, valueColumnTypes, true);
  ...
  protected MLDouble setEditedValues(
      SGMDArrayVariable var,
      MLDouble array,
      String xColumnType,
      String yColumnType,
    ...
    // get edited values
    Map<Integer, Double> valueMap =
        this.getEditedValueMap(var, xColumnType, yColumnType, valueColumnTypes, false);
