...
public abstract class SGElementGroupErrorBar extends SGElementGroup
  ...
  /**
   * A flag whether error bars positioned at line positions. If this flag is false, this error bars
   * positioned at bar positions.
   */
  ...
  public static class ErrorBarProperties extends ElementGroupProperties {
    ...
    public Object copy() {
      ...
      p.mErrorBarProperties =
          (SGDrawingElementErrorBar.ErrorBarProperties) this.mErrorBarProperties.copy();
   ...
   *
   * @param b true for vertical direction
   * @return true if succeeded
   */
