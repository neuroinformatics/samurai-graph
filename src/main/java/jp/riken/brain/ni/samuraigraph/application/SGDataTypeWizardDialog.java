...
public class SGDataTypeWizardDialog extends SGWizardDialog {
  ...
  private boolean initProperty() {
    ...
    this.setupButton(
        this.mPseudocolorMapButton, iconMap, PSEUDOCOLOR_MAP_ICON_FILENAME, PSEUDOCOLOR_MAP);
    this.pack();
  ...
  public void setDataFileType(FILE_TYPE type) {
    ...
    String[] names = {SINGLE_SXY, MULTIPLE_SXY, ORTHOGONAL_VXY, POLAR_VXY, PSEUDOCOLOR_MAP};
    AbstractButton[] buttons = {
      this.mSingleButton,
      this.mMultipleButton,
      this.mOrthogonalButton,
      this.mPolarButton,
    ...
    for (int ii = 0; ii < this.mDataTypeButtonArray.length; ii++) {
      this.mDataTypeButtonArray[ii] = new DataTypeButton(buttons[ii], dataTypes[ii], names[ii]);
    }
  ...
  protected void updateComponents() {
    final boolean samplingEnabled =
        this.mSingleButton.isSelected() || this.mMultipleButton.isSelected();
    this.mSamplingRateCheckBox.setEnabled(samplingEnabled);
    this.mSamplingRateField.setEnabled(samplingEnabled && this.mSamplingRateCheckBox.isSelected());
  }
  ...
  protected void setupButton(
      AbstractButton btn, Map<String, ImageIcon> iconMap, String iconFileName, String name) {
   ...
   *
   * @param b true to set enabled the sampling rate
   */
