...
public class SGSDArrayDataColumnSelectionPanel extends SGDataColumnSelectionPanel {
  ...
  /** Name of the column for the value type of each data column such as number or text. */
  public static final String COLUMN_NAME_VALUE_TYPE = "Value Type";

  public static final String[] COLUMN_NAME_ARRAY = {
    COLUMN_NAME_NUMBER, COLUMN_NAME_TITLE, COLUMN_NAME_VALUE_TYPE, COLUMN_NAME_COLUMN_TYPE
  };
  ...
  protected class TextDataColumnTableModel extends DataColumnTableModel {
    ...
    protected void addData(int index, SGDataColumnInfo data) {
      ...
      Object[] array = {Integer.toString(index + 1), data.getTitle(), data.getValueType(), cType};
      super.addRow(array);
    }
  }
