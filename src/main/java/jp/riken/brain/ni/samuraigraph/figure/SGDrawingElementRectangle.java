...
public abstract class SGDrawingElementRectangle extends SGDrawingElement
   ...
   *
   * @param alpha alpha value to set transparent
   */
  ...
  /** */
  public boolean setBounds(final float x, final float y, final float w, final float h) {
  ...
  protected void addProperties(
      SGPropertyMap map,
      String edgeLineWidthKey,
      String edgeLineTypeKey,
      String edgeLineColorKey,
      String edgeLineVisibleKey) {
  ...
  protected boolean contains(final int x, final int y, SGTuple2f location) {
    ...
    Rectangle2D rect =
        new Rectangle2D.Float(location.x - halfWidth, location.y - halfHeight, width, height);
