...
/** Constants for data commands. */
public final class SGIDataCommandConstants {

  /** Private constructor to prevent instantiation. */
  private SGIDataCommandConstants() {}

  /**
   * The symbol for the file path in command script in a global attribute of a NetCDF file. When the
   * file path is given by this symbol, the NetCDF file is used as the data file.
   */
