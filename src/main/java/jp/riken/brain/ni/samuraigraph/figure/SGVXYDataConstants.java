...
public class SGVXYDataConstants {
  ...
  // Start Head Type
  public static final int DEFAULT_START_HEAD_TYPE = SYMBOL_TYPE_VOID;

  // End Head Type
  public static final int DEFAULT_END_HEAD_TYPE = SYMBOL_TYPE_ARROW_HEAD;
