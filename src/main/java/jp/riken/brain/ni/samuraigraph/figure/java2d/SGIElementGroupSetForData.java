...
public interface SGIElementGroupSetForData extends SGIChildObject, SGIDataObject {
   ...
   * Sets the name.
   *
   * @param name a text string to set to the name
   ...
   *
   * @param type the type of element group to add
   * @return true if succeeded
   */
   ...
   * @return true if succeeded
   */
  public boolean saveData(final File file, final SGExportParameter mode, SGDataBufferPolicy policy);
