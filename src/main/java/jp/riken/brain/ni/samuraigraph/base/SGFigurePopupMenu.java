  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (command.equals(SGFigure.MENUCMD_RUBBER_BANDING)) {
      ...
      SGCheckBoxMenuItem item =
          (SGCheckBoxMenuItem) this.findMenuItem(SGFigure.MENUCMD_LEGEND_VISIBLE);
      ...
      SGCheckBoxMenuItem item =
          (SGCheckBoxMenuItem) this.findMenuItem(SGFigure.MENUCMD_COLOR_BAR_VISIBLE);
      final boolean b = item.isSelected();
      for (SGFigure fig : this.mFigureList) {
      ...
      SGCheckBoxMenuItem item =
          (SGCheckBoxMenuItem) this.findMenuItem(SGFigure.MENUCMD_SCALE_VISIBLE);
      final boolean b = item.isSelected();
      for (SGFigure fig : this.mFigureList) {
      ...
      SGCheckBoxMenuItem item =
          (SGCheckBoxMenuItem) this.findMenuItem(SGFigure.MENUCMD_GRID_VISIBLE);
      final boolean b = item.isSelected();
      for (SGFigure fig : this.mFigureList) {
      ...
      SGCheckBoxMenuItem item =
          (SGCheckBoxMenuItem) this.findMenuItem(SGFigure.MENUCMD_DATA_ANCHORED);
      final boolean b = item.isSelected();
      for (SGFigure fig : this.mFigureList) {
