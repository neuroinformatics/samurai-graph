...
public class SGStatusBar extends JPanel implements SGIConstants, SGIProgressControl {
  ...
  private static class MessagePanel extends StatusPanel {
    ...
    private MessagePanel() {
      super();
      this.setPreferredSize(new Dimension(120, SGStatusBar.STATUS_BAR_WIDTH));
    }
  }
  ...
  private static class PositionPanel extends StatusPanel {
    ...
    private PositionPanel() {
      ...
      // size
      this.setPreferredSize(new Dimension(80, SGStatusBar.STATUS_BAR_WIDTH));
  ...
  private static class AxisValuePanel extends StatusPanel {
    ...
    private AxisValuePanel() {
      ...
      // size
      this.setPreferredSize(new Dimension(240, SGStatusBar.STATUS_BAR_WIDTH));
