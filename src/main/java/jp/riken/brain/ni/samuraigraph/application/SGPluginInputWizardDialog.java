...
public class SGPluginInputWizardDialog extends SGWizardDialog {
  ...
  private void initComponents() {
    ...
    mParameterScrollPane.setHorizontalScrollBarPolicy(
  ...
  public static final String[] PARAMETER_COLUMN_NAME_ARRAY = {
    COLUMN_NAME_NUMBER, COLUMN_NAME_NAME, COLUMN_NAME_VALUE
  };
