...
/** Constants for figure elements. */
public final class SGIFigureElementConstants {

    /** Private constructor to prevent instantiation. */
    private SGIFigureElementConstants() {}
    ...
    public static final String SHOW_PROPERTY_DIALOG_FOR_SELECTED_OBJECTS =
            "Show property dialog for selected objects";

    public static final String SHOW_PROPERTY_DIALOG_FOR_VISIBLE_OBJECTS =
            "Show property dialog for visible objects";

    public static final String SHOW_PROPERTY_DIALOG_FOR_ALL_OBJECTS =
            "Show property dialog for all objects";
    ...
    public static final String NOTIFY_DATA_STRUCTURE_CHANGE_ON_CANCEL =
            "Data structure is changed on cancel";

    public static final String NOTIFY_DATA_STRUCTURE_CHANGE_ON_COMMIT =
            "Data structure is changed on commit";

    public static final String NOTIFY_DATA_PROPERTIES_CHANGE_ON_PREVIEW =
            "Data properties are changed on preview";

    public static final String NOTIFY_DATA_PROPERTIES_CHANGE_ON_CANCEL =
            "Data properties are changed on cancel";

    public static final String NOTIFY_DATA_PROPERTIES_CHANGE_ON_COMMIT =
            "Data properties are changed on commit";
