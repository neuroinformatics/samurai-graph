...
public abstract class SGElementGroupSetInGraph extends SGElementGroupSetForData
  ...
  public boolean cancel() {
    ...
    ElementGroupSetPropertiesInFigureElement eg =
  ...
  protected abstract void setFocusedValueIndices(
  ...
  protected final Map<SGDataViewerDialog, List<SGTuple2d>> mFocusedValueListMap =
      new HashMap<SGDataViewerDialog, List<SGTuple2d>>();
  ...
  protected List<SGTwoDimensionalArrayIndex> mDataTableCellList =
      new ArrayList<SGTwoDimensionalArrayIndex>();
