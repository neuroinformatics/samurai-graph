...
/**
 * The modifier class to insert an escape character before each brace that is not used for subscript
 * nor superscript.
 */
public class SGStringBraceModifier implements SGIStringModifier {
  ...
  private static class DrawingElementString2DExtendedOlder
    ...
    public DrawingElementString2DExtendedOlder(
        final String str,
