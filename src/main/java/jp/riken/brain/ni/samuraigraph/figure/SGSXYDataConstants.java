...
public class SGSXYDataConstants {
  ...
  // Type
  public static final int DEFAULT_LINE_TYPE = SGLineConstants.LINE_TYPE_SOLID;
  ...
  // Type
  public static final int DEFAULT_SYMBOL_TYPE = SGSymbolConstants.SYMBOL_TYPE_CIRCLE;
  ...
  public static final int DEFAULT_ERROR_BAR_SYMBOL_TYPE =
      SGArrowConstants.SYMBOL_TYPE_TRANSVERSELINE;
  ...
  // Style
  public static final int DEFAULT_ERROR_BAR_STYLE = SGErrorBarConstants.ERROR_BAR_BOTHSIDES;
