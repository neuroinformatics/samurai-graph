...
public class SGTuple2f implements Cloneable {
  ...
  /**
   * Constructs and initializes a SGTuple2f with a given tuple.
   *
   * @param tuple a tuple
   */
  ...
  /**
   * Checks whether a given object is equal to this object. Both of two components are equal to
   * those of this object, a given object is equal to this.
   *
   * @param obj an object to compare
   * @return true if a given object is equal to this
   */
  public boolean equals(final Object obj) {
    if ((obj instanceof SGTuple2f) == false) {
      return false;
    }
