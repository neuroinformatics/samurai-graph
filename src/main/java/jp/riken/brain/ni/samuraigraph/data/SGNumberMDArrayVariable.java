...
public abstract class SGNumberMDArrayVariable extends SGMDArrayVariable {
  ...
  // Factors for each term of dimension index are calculated and stored in the attribute of this
  // class, mFactors.
  // In the subclass of this class, SGVirtualMDArrayVariable, array values are stored in the same
  // ordering in an
  // attribute, mValues.
