...
public class SGAxisBreakDialog extends SGPropertyDialog
    implements SGIAxisBreakConstants, SGITwoAxesDialog {
  ...
  private boolean initProperty() {
    ...
    this.mLengthSpinner.initProperties(
        ...
        AXIS_BREAK_LENGTH_FRAC_DIFIT_MIN,
        AXIS_BREAK_LENGTH_FRAC_DIFIT_MAX);
    ...
    this.mIntervalSpinner.initProperties(
        ...
        AXIS_BREAK_INTERVAL_FRAC_DIFIT_MIN,
        AXIS_BREAK_INTERVAL_FRAC_DIFIT_MAX);
    ...
    this.mDistortionSpinner.initProperties(
        ...
        null,
        AXIS_BREAK_DISTORTION_FRAC_DIFIT_MIN,
        AXIS_BREAK_DISTORTION_FRAC_DIFIT_MAX);
    ...
    SGComponentGroupElement[] dateXComponents = {new SGComponentGroupElement(this.mXDateButton)};
    SGComponentGroupElement[] dateYComponents = {new SGComponentGroupElement(this.mYDateButton)};
  ...
  public boolean setDialogProperty() {
    ...
    SGIAxisBreakDialogObserver abs0 = (SGIAxisBreakDialogObserver) list.get(0);
