...
public class SGLineStylePropertyDialog extends SGPropertyDialog {
  ...
  public boolean putLineStylePropertyDialogObserverList(
      final int figureId, final List<SGILineStylePropertyDialogObserver> obsList) {
  ...
  public boolean setDialogProperty() {
    ...
    for (int ii = 0; ii < this.mPropertyDialogObserverList.size(); ii++) {
      SGILineStylePropertyDialogObserver obs =
          (SGILineStylePropertyDialogObserver) this.mPropertyDialogObserverList.get(ii);
