...
public class SGPropertyMap implements Cloneable {
  ...
  /**
   * Returns a text string of the value related to the given key. The returned value is trimmed, and
   * if double quotations exist on the both side of it, they are removed. If the value for the given
