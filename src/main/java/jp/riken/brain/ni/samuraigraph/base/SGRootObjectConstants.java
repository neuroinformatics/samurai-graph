...
public class SGRootObjectConstants {
  ...
  public static final String LAF_CLASS_NAME_MOTIF =
  ...
  public static final int[] MAGNIFICATION_ARRAY = {400, 300, 200, 150, 100, 75, 66, 50, 33, 25};

  public static final String AUTO_ZOOM_IN_COMBO_BOX = "Auto";

  public static final String[] MAGNIFICATION_STRING_ARRAY = {
  ...
  // width of viewport
  public static final float DEFAULT_VIEWPORT_WIDTH = 20.0f / CM_POINT_RATIO;

  // height of viewport
  public static final float DEFAULT_VIEWPORT_HEIGHT = 20.0f / CM_POINT_RATIO;

  // paper width
  public static final float DEFAULT_PAPER_WIDTH =
      (MediaSize.ISO.A4.getX(Size2DSyntax.MM) / 10.0f) / CM_POINT_RATIO;

  // paper height
  public static final float DEFAULT_PAPER_HEIGHT =
      (MediaSize.ISO.A4.getY(Size2DSyntax.MM) / 10.0f) / CM_POINT_RATIO;
  ...
  // grid interval
  public static final float DEFAULT_GRID_INTERVAL = 1.0f / CM_POINT_RATIO;
