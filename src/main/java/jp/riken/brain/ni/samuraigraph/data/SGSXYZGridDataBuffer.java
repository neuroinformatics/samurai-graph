...
public class SGSXYZGridDataBuffer extends SGTwoDimensionalDataBuffer {
  ...
  public SGSXYZGridDataBuffer(
      double[] xValues, double[] yValues, List<SGXYSimpleDoubleValueIndexBlock> zValueBlocks) {
  ...
  public SGSXYZGridDataBuffer(double[] xValues, double[] yValues, double[][] zValues) {
    super(xValues, yValues);
