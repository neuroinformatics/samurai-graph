...
public class SGDataViewerDialog extends SGDialog {
  ...
  private void initComponents() {
    ...
    mColumnTypeComboBox = new jp.riken.brain.ni.samuraigraph.base.SGComboBox<String>();
    ...
    mTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] {}));
  ...
  private jp.riken.brain.ni.samuraigraph.base.SGComboBox<String> mColumnTypeComboBox;
  ...
  private void initProperty() {
    ...
    this.mColumnTypeComboBox.addItemListener(
        new ItemListener() {
          @Override
    ...
    this.mTable.addMouseMotionListener(
        new MouseAdapter() {
          @Override
          public void mouseDragged(MouseEvent e) {
            final int col = mTable.columnAtPoint(e.getPoint());
    ...
    this.mScrollPane.addMouseListener(
        new MouseAdapter() {
          @Override
          public void mouseClicked(MouseEvent e) {
            clearSelection();
    ...
    this.mClearSelectionButton.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            clearSelection();
          }
        });
    this.mHideEmptyCellsCheckBox.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
    ...
    this.mHighlightDataCheckBox.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
  ...
  public void setData(final SGData data, final String name) {
    ...
    this.mColumnTypeComboBox.setSelectedItem(data.getPreferredDataViewColumnType());
  ...
  private SGTwoDimensionalArrayIndex getIndex(
      final String columnType, final int tableRowIndex, final int tableColumnIndex) {
  ...
  class DataViewerTable extends JTable {
    ...
    public void changeSelection(
        final int rowIndex, final int columnIndex, final boolean toggle, final boolean extend) {
      if (columnIndex != 0) {
    ...
    public void editingStopped(ChangeEvent e) {
      ...
      SGDataViewerDialog.this.setValueAt(
          editor.mLastEditedRow, editor.mLastEditedColumn, editor.getCellEditorValue());
  ...
  public void setSelectedIndices(List<SGTwoDimensionalArrayIndex> indexList) {
    ...
    for (SGTwoDimensionalArrayIndex cell : indexList) {
      final boolean bStride =
          this.mData.isStrideAvailable() && this.mHideEmptyCellsCheckBox.isSelected();
      SGTwoDimensionalArrayIndex cellNew = this.mData.getDataViewerCell(cell, columnType, bStride);
