...
public class SGStrokeDash implements Cloneable {
   ...
   *
   * @param lineNum1 The number of the first line segments.
   * @param lineNum2 The number of the second line segments.
   * @param lineLen1 The length of the first line segments.
   * @param lineLen2 The length of the second line segments.
   * @param space The space between line segments.
   */
