...
public class SGDataInformationKeyConstants {
  ...
  public static final String KEY_SXY_MDARRAY_PICKUP_DIMENSION_INDEX_MAP =
      "Pickup dimension index map";
  ...
  /**
   * A key string for the start index of multiple graph of dimension. (Only for the version older
   * than 2.1.0.)
   */
  public static final String KEY_SXY_PICKUP_DIMENSION_START = "Multiple dimension start";

  /**
   * A key string for the last index of multiple graph of dimension. (Only for the version older
   * than 2.1.0.)
   */
  public static final String KEY_SXY_PICKUP_DIMENSION_END = "Multiple dimension end";

  /**
   * A key string for the step of multiple graph of dimension. (Only for the version older than
   * 2.1.0.)
   */
