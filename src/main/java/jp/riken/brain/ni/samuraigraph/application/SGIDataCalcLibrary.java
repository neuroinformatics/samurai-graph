...
public interface SGIDataCalcLibrary extends SGIBaseLibrary {
  ...
  public abstract static class AbstractStructure extends Structure {
  ...
  public abstract static class ArrayStructure extends AbstractStructure {
    /** The default constructor. */
  ...
  public abstract static class OneDimensionalDataStructure extends ArrayStructure {
    public static int length = 0;
    public int len;
  ...
  public abstract static class TwoDimensionalDoubleStructure extends ArrayStructure {
  ...
  public static class Writer {
    ...
    public static void write(SGDataBuffer[] buffers, Pointer p) {
      ...
      for (int ii = 0; ii < dataTypes.length; ii++) {
        ...
        int type = -1;
        if (buffer instanceof SGSXYDataBuffer || buffer instanceof SGSXYMultipleDataBuffer) {
          type = DATA_TYPE_SXY;
  ...
  public static class Reader {
    ...
    public static double[][] readTwoDimensionalDoubleArray(
        Pointer p, final int lenX, final int lenY) {
