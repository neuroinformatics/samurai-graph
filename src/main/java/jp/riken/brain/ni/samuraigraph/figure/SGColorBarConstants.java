...
public class SGColorBarConstants {
  ...
  // Horizontal Axis
  public static final String DEFAULT_COLOR_BAR_HORIZONTAL_AXIS =
      SGFigureElementAxisConstants.AXIS_BOTTOM;

  // Vertical Axis
  public static final String DEFAULT_COLOR_BAR_VERTICAL_AXIS =
