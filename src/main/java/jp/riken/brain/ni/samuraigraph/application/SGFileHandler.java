...
public class SGFileHandler {
  ...
  protected void initFilePath(final String defaultName, final String extension) {
    this.mCurrentDirectory = this.initDirectory();
  ...
  private JFileChooser createFileChooser(String ext, String desc, String defaultFileName) {
    JFileChooser chooser =
        SGApplicationUtility.createFileChooser(
            this.mCurrentDirectory, this.mCurrentFileName, ext, desc, defaultFileName);
    return chooser;
  }

  protected File selectOutputFile(Component parent, String ext, String desc, String defaultFileName)
      throws IOException {
