...
public class SGPaintUtility implements SGIPaintConstant {
  ...
  //        el.setAttribute(KEY_FILL_COLOR,
  // SGUtilityText.getColorString((Color)paint.getPaint(null)));
  //        return true;
  //    }
  //
  //    public static boolean writePropertyPatternPaint(final Element el, final SGPatternPaint
  // paint) {
  ...
  //    }
  //
  //    public static boolean writePropertyGradationPaint(final Element el, final SGGradationPaint
  // paint) {
  ...
  //        el.setAttribute(KEY_GRADATION_DIRECTION,
  // SGGradationPaint.getDirectionName(paint.getDirectionIndex()));
  //        el.setAttribute(KEY_GRADATION_ORDER,
  // SGGradationPaint.getOrderName(paint.getOrderIndex()));
  //        return true;
  //    }
  //
  //    public static boolean writePropertySelectablePaint(final Element el, final SGSelectablePaint
  // paint) {
  //        el.setAttribute(KEY_PAINT_STYLE,
  // SGSelectablePaint.getStyleName(paint.getSelectedStyle()));
  //        el.setAttribute(KEY_FILL_COLOR, SGUtilityText.getColorString(paint.getFillColor()));
  //        el.setAttribute(KEY_PATTERN_COLOR,
  // SGUtilityText.getColorString(paint.getPatternColor()));
