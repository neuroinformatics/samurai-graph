...
public class SGApplicationConstants {
  ...
  public static enum RELOAD_DATA_STATUS {
    SUCCEEDED,
    LOST,
    INVALID_DATA,
    NULL,
  ...
  public static final String PROGRESS_MESSAGE_READ_FILE = "Read File";

  public static final String PROGRESS_MESSAGE_CREATE_DATA = "Create Data";
