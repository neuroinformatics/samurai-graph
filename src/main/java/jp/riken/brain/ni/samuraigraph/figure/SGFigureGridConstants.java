...
public class SGFigureGridConstants {
  ...
  // Line Type
  public static final int DEFAULT_GRID_LINE_TYPE = LINE_TYPE_DOTTED;

  // Line Color
  public static final Color DEFAULT_GRID_COLOR = Color.GRAY;

  // Horizontal Axis
  public static final String DEFAULT_GRID_HORIZONTAL_AXIS =
      SGFigureElementAxisConstants.AXIS_BOTTOM;

  // Vertical Axis
  public static final String DEFAULT_GRID_VERTICAL_AXIS = SGFigureElementAxisConstants.AXIS_LEFT;
