...
public class SGShapeConstants {
  ...
  // X Axis
  public static final String DEFAULT_SHAPE_HORIZONTAL_AXIS =
      SGFigureElementAxisConstants.AXIS_BOTTOM;

  // Y Axis
  public static final String DEFAULT_SHAPE_VERTICAL_AXIS = SGFigureElementAxisConstants.AXIS_LEFT;
  ...
  // Line Type
  public static final int DEFAULT_SHAPE_LINE_TYPE = SGLineConstants.LINE_TYPE_SOLID;
  ...
  // Start Head Type
  public static final int DEFAULT_SHAPE_ARROW_START_HEAD_TYPE = SGArrowConstants.SYMBOL_TYPE_VOID;

  // End Head Type
  public static final int DEFAULT_SHAPE_ARROW_END_HEAD_TYPE =
      SGArrowConstants.SYMBOL_TYPE_ARROW_HEAD;
  ...
  public static final String COM_RECTANGLE_BACKGROUND_GRADATION_COLOR1 =
      "BackgroundGradationColor1";

  public static final String COM_RECTANGLE_BACKGROUND_GRADATION_COLOR2 =
      "BackgroundGradationColor2";

  public static final String COM_RECTANGLE_BACKGROUND_GRADATION_DIRECTION =
      "BackgroundGradationDirection";
