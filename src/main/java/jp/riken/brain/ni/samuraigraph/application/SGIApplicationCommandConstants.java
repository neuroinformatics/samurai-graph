...
public interface SGIApplicationCommandConstants
    extends SGIRootObjectConstants, SGIFigureConstants, SGIDataCommandConstants, SGIAxisConstants {
  ...
  public static final String COM_BRING_TO_FRONT_FIGURE =
      COM_HEADER_BRING_TO_FRONT + SGIFigureConstants.COM_FIGURE;

  public static final String COM_BRING_FORWARD_FIGURE =
      COM_HEADER_BRING_FORWARD + SGIFigureConstants.COM_FIGURE;

  public static final String COM_SEND_BACKWARD_FIGURE =
      COM_HEADER_SEND_BACKWARD + SGIFigureConstants.COM_FIGURE;

  public static final String COM_SEND_TO_BACK_FIGURE =
      COM_HEADER_SEND_TO_BACK + SGIFigureConstants.COM_FIGURE;

  //
  // data
  //

  public static final String COM_BRING_TO_FRONT_DATA =
      COM_HEADER_BRING_TO_FRONT + SGIDataCommandConstants.COM_DATA;

  public static final String COM_BRING_FORWARD_DATA =
      COM_HEADER_BRING_FORWARD + SGIDataCommandConstants.COM_DATA;

  public static final String COM_SEND_BACKWARD_DATA =
      COM_HEADER_SEND_BACKWARD + SGIDataCommandConstants.COM_DATA;

  public static final String COM_SEND_TO_BACK_DATA =
      COM_HEADER_SEND_TO_BACK + SGIDataCommandConstants.COM_DATA;
  ...
  public static final String COM_BRING_TO_FRONT_LABEL =
      COM_HEADER_BRING_TO_FRONT + SGIStringConstants.COM_LABEL;

  public static final String COM_BRING_FORWARD_LABEL =
      COM_HEADER_BRING_FORWARD + SGIStringConstants.COM_LABEL;

  public static final String COM_SEND_BACKWARD_LABEL =
      COM_HEADER_SEND_BACKWARD + SGIStringConstants.COM_LABEL;

  public static final String COM_SEND_TO_BACK_LABEL =
      COM_HEADER_SEND_TO_BACK + SGIStringConstants.COM_LABEL;
  ...
  public static final String COM_BRING_TO_FRONT_SIGDIFF =
      COM_HEADER_BRING_TO_FRONT + SGISignificantDifferenceConstants.COM_SIGNIFICANT_DIFFERENCE;

  public static final String COM_BRING_FORWARD_SIGDIFF =
      COM_HEADER_BRING_FORWARD + SGISignificantDifferenceConstants.COM_SIGNIFICANT_DIFFERENCE;

  public static final String COM_SEND_BACKWARD_SIGDIFF =
      COM_HEADER_SEND_BACKWARD + SGISignificantDifferenceConstants.COM_SIGNIFICANT_DIFFERENCE;

  public static final String COM_SEND_TO_BACK_SIGDIFF =
      COM_HEADER_SEND_TO_BACK + SGISignificantDifferenceConstants.COM_SIGNIFICANT_DIFFERENCE;
  ...
  public static final String COM_BRING_TO_FRONT_BREAK =
      COM_HEADER_BRING_TO_FRONT + SGIAxisBreakConstants.COM_AXIS_BREAK;

  public static final String COM_BRING_FORWARD_BREAK =
      COM_HEADER_BRING_FORWARD + SGIAxisBreakConstants.COM_AXIS_BREAK;

  public static final String COM_SEND_BACKWARD_BREAK =
      COM_HEADER_SEND_BACKWARD + SGIAxisBreakConstants.COM_AXIS_BREAK;

  public static final String COM_SEND_TO_BACK_BREAK =
      COM_HEADER_SEND_TO_BACK + SGIAxisBreakConstants.COM_AXIS_BREAK;
  ...
  public static final String COM_BRING_TO_FRONT_TIMING_LINE =
      COM_HEADER_BRING_TO_FRONT + SGITimingLineConstants.COM_TIMING_LINE;

  public static final String COM_BRING_FORWARD_TIMING_LINE =
      COM_HEADER_BRING_FORWARD + SGITimingLineConstants.COM_TIMING_LINE;

  public static final String COM_SEND_BACKWARD_TIMING_LINE =
      COM_HEADER_SEND_BACKWARD + SGITimingLineConstants.COM_TIMING_LINE;

  public static final String COM_SEND_TO_BACK_TIMING_LINE =
      COM_HEADER_SEND_TO_BACK + SGITimingLineConstants.COM_TIMING_LINE;
  ...
  public static final String COM_BRING_TO_FRONT_SHAPE =
      COM_HEADER_BRING_TO_FRONT + SGIShapeConstants.COM_SHAPE;

  public static final String COM_BRING_FORWARD_SHAPE =
      COM_HEADER_BRING_FORWARD + SGIShapeConstants.COM_SHAPE;

  public static final String COM_SEND_BACKWARD_SHAPE =
      COM_HEADER_SEND_BACKWARD + SGIShapeConstants.COM_SHAPE;

  public static final String COM_SEND_TO_BACK_SHAPE =
      COM_HEADER_SEND_TO_BACK + SGIShapeConstants.COM_SHAPE;
