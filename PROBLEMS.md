...
| 5,157 | `base/SGDrawingWindow.java` | Frame handling mixed with window logic; delegates to clipboard, alignment, property I/O, viewport, property dialog, and undo helpers |
