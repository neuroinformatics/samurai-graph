...
Actual JaCoCo measurement (line coverage) is **8.9%** overall.
...
| `jp...samuraigraph.data` | 17.1% | 43 | Largest application package |
...
- 83 test files / 877 test methods (907 executions) against 590 main files
  / ~275k LOC
